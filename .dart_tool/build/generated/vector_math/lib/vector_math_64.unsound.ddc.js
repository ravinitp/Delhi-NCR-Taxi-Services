define(['dart_sdk', 'packages/vector_math/hash'], (function load__packages__vector_math__vector_math_64(dart_sdk, packages__vector_math__hash) {
  'use strict';
  ...
  var Matrix2L = () => (Matrix2L = dart.constFn(dart.legacy(vector_math_64.Matrix2)))();
  var Vector2L = () => (Vector2L = dart.constFn(dart.legacy(vector_math_64.Vector2)))();
  var Matrix3L = () => (Matrix3L = dart.constFn(dart.legacy(vector_math_64.Matrix3)))();
  var Vector3L = () => (Vector3L = dart.constFn(dart.legacy(vector_math_64.Vector3)))();
  var Matrix4L = () => (Matrix4L = dart.constFn(dart.legacy(vector_math_64.Matrix4)))();
  var Vector4L = () => (Vector4L = dart.constFn(dart.legacy(vector_math_64.Vector4)))();
  ...
  var L1 = "org-dartlang-app:///packages/vector_math/src/vector_math_64/matrix2.dart";
  var L3 = "org-dartlang-app:///packages/vector_math/src/vector_math_64/matrix4.dart";
  var L4 = "org-dartlang-app:///packages/vector_math/src/vector_math_64/obb3.dart";
  var L0 = "package:vector_math/vector_math_64.dart";
  var L2 = "org-dartlang-app:///packages/vector_math/src/vector_math_64/matrix3.dart";
  var L5 = "org-dartlang-app:///packages/vector_math/src/vector_math_64/quaternion.dart";
  var _min = dart.privateName(vector_math_64, "_min");
  var _max = dart.privateName(vector_math_64, "_max");
  ...
  dart.setMethodSignature(vector_math_64.Aabb2, () => ({
    ...
    setCenterAndHalfExtents: dart.fnType(dart.void, [dart.legacy(vector_math_64.Vector2), dart.legacy(vector_math_64.Vector2)]),
    copyCenterAndHalfExtents: dart.fnType(dart.void, [dart.legacy(vector_math_64.Vector2), dart.legacy(vector_math_64.Vector2)]),
    copyFrom: dart.fnType(dart.void, [dart.legacy(vector_math_64.Aabb2)]),
    transform: dart.fnType(dart.void, [dart.legacy(vector_math_64.Matrix3)]),
    rotate: dart.fnType(dart.void, [dart.legacy(vector_math_64.Matrix3)]),
    transformed: dart.fnType(dart.legacy(vector_math_64.Aabb2), [dart.legacy(vector_math_64.Matrix3), dart.legacy(vector_math_64.Aabb2)]),
    rotated: dart.fnType(dart.legacy(vector_math_64.Aabb2), [dart.legacy(vector_math_64.Matrix3), dart.legacy(vector_math_64.Aabb2)]),
    hull: dart.fnType(dart.void, [dart.legacy(vector_math_64.Aabb2)]),
    hullPoint: dart.fnType(dart.void, [dart.legacy(vector_math_64.Vector2)]),
    containsAabb2: dart.fnType(dart.legacy(core.bool), [dart.legacy(vector_math_64.Aabb2)]),
    containsVector2: dart.fnType(dart.legacy(core.bool), [dart.legacy(vector_math_64.Vector2)]),
    intersectsWithAabb2: dart.fnType(dart.legacy(core.bool), [dart.legacy(vector_math_64.Aabb2)]),
    intersectsWithVector2: dart.fnType(dart.legacy(core.bool), [dart.legacy(vector_math_64.Vector2)])
  }));
  dart.setGetterSignature(vector_math_64.Aabb2, () => ({
    __proto__: dart.getGetters(vector_math_64.Aabb2.__proto__),
    min: dart.legacy(vector_math_64.Vector2),
    max: dart.legacy(vector_math_64.Vector2),
    center: dart.legacy(vector_math_64.Vector2)
  }));
  dart.setLibraryUri(vector_math_64.Aabb2, L0);
  dart.setFieldSignature(vector_math_64.Aabb2, () => ({
    __proto__: dart.getFields(vector_math_64.Aabb2.__proto__),
    [_min]: dart.finalFieldType(dart.legacy(vector_math_64.Vector2)),
    [_max]: dart.finalFieldType(dart.legacy(vector_math_64.Vector2))
  }));
  var _radius = dart.privateName(vector_math_64, "_radius");
  var _center = dart.privateName(vector_math_64, "_center");
  var _point0 = dart.privateName(vector_math_64, "_point0");
  var _point1 = dart.privateName(vector_math_64, "_point1");
  var _point2 = dart.privateName(vector_math_64, "_point2");
  var _point3 = dart.privateName(vector_math_64, "_point3");
  var _depth = dart.privateName(vector_math_64, "_depth");
  vector_math_64.Aabb3 = class Aabb3 extends core.Object {
    ...
    setTriangle(triangle) {
      this[_min].setValues(math.min(doubleL(), triangle[_point0].x, math.min(doubleL(), triangle[_point1].x, triangle[_point2].x)), math.min(doubleL(), triangle[_point0].y, math.min(doubleL(), triangle[_point1].y, triangle[_point2].y)), math.min(doubleL(), triangle[_point0].z, math.min(doubleL(), triangle[_point1].z, triangle[_point2].z)));
      this[_max].setValues(math.max(doubleL(), triangle[_point0].x, math.max(doubleL(), triangle[_point1].x, triangle[_point2].x)), math.max(doubleL(), triangle[_point0].y, math.max(doubleL(), triangle[_point1].y, triangle[_point2].y)), math.max(doubleL(), triangle[_point0].z, math.max(doubleL(), triangle[_point1].z, triangle[_point2].z)));
    }
    setQuad(quad) {
      this[_min].setValues(math.min(doubleL(), quad[_point0].x, math.min(doubleL(), quad[_point1].x, math.min(doubleL(), quad[_point2].x, quad[_point3].x))), math.min(doubleL(), quad[_point0].y, math.min(doubleL(), quad[_point1].y, math.min(doubleL(), quad[_point2].y, quad[_point3].y))), math.min(doubleL(), quad[_point0].z, math.min(doubleL(), quad[_point1].z, math.min(doubleL(), quad[_point2].z, quad[_point3].z))));
      this[_max].setValues(math.max(doubleL(), quad[_point0].x, math.max(doubleL(), quad[_point1].x, math.max(doubleL(), quad[_point2].x, quad[_point3].x))), math.max(doubleL(), quad[_point0].y, math.max(doubleL(), quad[_point1].y, math.max(doubleL(), quad[_point2].y, quad[_point3].y))), math.max(doubleL(), quad[_point0].z, math.max(doubleL(), quad[_point1].z, math.max(doubleL(), quad[_point2].z, quad[_point3].z))));
    }
    setObb3(obb) {
    ...
    intersectsWithTriangle(other, opts) {
      ...
      if (dart.notNull(len) > dart.notNull(epsilon)) {
        ...
        if (math.max(doubleL(), -math.max(doubleL(), p0, p2), math.min(doubleL(), p0, p2)) > dart.notNull(r) + dart.notNull(epsilon)) {
          return false;
        }
        a = math.min(doubleL(), p0, p2) - dart.notNull(r);
      ...
      if (dart.notNull(len) > dart.notNull(epsilon)) {
        ...
        if (math.max(doubleL(), -math.max(doubleL(), p0, p1), math.min(doubleL(), p0, p1)) > dart.notNull(r) + dart.notNull(epsilon)) {
          return false;
        }
        a = math.min(doubleL(), p0, p1) - dart.notNull(r);
        if (result != null && (result[_depth] == null || dart.notNull(result[_depth]) < dart.notNull(a))) {
          result[_depth] = a;
      ...
      if (math.max(doubleL(), vector_math_64.Aabb3._v0.x, math.max(doubleL(), vector_math_64.Aabb3._v1.x, vector_math_64.Aabb3._v2.x)) < -dart.notNull(vector_math_64.Aabb3._aabbHalfExtents._get(0)) || math.min(doubleL(), vector_math_64.Aabb3._v0.x, math.min(doubleL(), vector_math_64.Aabb3._v1.x, vector_math_64.Aabb3._v2.x)) > dart.notNull(vector_math_64.Aabb3._aabbHalfExtents._get(0))) {
        return false;
      }
      a = math.min(doubleL(), vector_math_64.Aabb3._v0.x, math.min(doubleL(), vector_math_64.Aabb3._v1.x, vector_math_64.Aabb3._v2.x)) - dart.notNull(vector_math_64.Aabb3._aabbHalfExtents._get(0));
      if (result != null && (result[_depth] == null || dart.notNull(result[_depth]) < dart.notNull(a))) {
        result[_depth] = a;
        result.axis.setFrom(vector_math_64.Aabb3._u0);
      }
      if (math.max(doubleL(), vector_math_64.Aabb3._v0.y, math.max(doubleL(), vector_math_64.Aabb3._v1.y, vector_math_64.Aabb3._v2.y)) < -dart.notNull(vector_math_64.Aabb3._aabbHalfExtents._get(1)) || math.min(doubleL(), vector_math_64.Aabb3._v0.y, math.min(doubleL(), vector_math_64.Aabb3._v1.y, vector_math_64.Aabb3._v2.y)) > dart.notNull(vector_math_64.Aabb3._aabbHalfExtents._get(1))) {
        return false;
      }
      a = math.min(doubleL(), vector_math_64.Aabb3._v0.y, math.min(doubleL(), vector_math_64.Aabb3._v1.y, vector_math_64.Aabb3._v2.y)) - dart.notNull(vector_math_64.Aabb3._aabbHalfExtents._get(1));
      if (result != null && (result[_depth] == null || dart.notNull(result[_depth]) < dart.notNull(a))) {
        result[_depth] = a;
        result.axis.setFrom(vector_math_64.Aabb3._u1);
      }
      if (math.max(doubleL(), vector_math_64.Aabb3._v0.z, math.max(doubleL(), vector_math_64.Aabb3._v1.z, vector_math_64.Aabb3._v2.z)) < -dart.notNull(vector_math_64.Aabb3._aabbHalfExtents._get(2)) || math.min(doubleL(), vector_math_64.Aabb3._v0.z, math.min(doubleL(), vector_math_64.Aabb3._v1.z, vector_math_64.Aabb3._v2.z)) > dart.notNull(vector_math_64.Aabb3._aabbHalfExtents._get(2))) {
        return false;
      }
      a = math.min(doubleL(), vector_math_64.Aabb3._v0.z, math.min(doubleL(), vector_math_64.Aabb3._v1.z, vector_math_64.Aabb3._v2.z)) - dart.notNull(vector_math_64.Aabb3._aabbHalfExtents._get(2));
      if (result != null && (result[_depth] == null || dart.notNull(result[_depth]) < dart.notNull(a))) {
        result[_depth] = a;
  ...
  dart.setMethodSignature(vector_math_64.Aabb3, () => ({
    ...
    setCenterAndHalfExtents: dart.fnType(dart.void, [dart.legacy(vector_math_64.Vector3), dart.legacy(vector_math_64.Vector3)]),
    setSphere: dart.fnType(dart.void, [dart.legacy(vector_math_64.Sphere)]),
    setTriangle: dart.fnType(dart.void, [dart.legacy(vector_math_64.Triangle)]),
    setQuad: dart.fnType(dart.void, [dart.legacy(vector_math_64.Quad)]),
    setObb3: dart.fnType(dart.void, [dart.legacy(vector_math_64.Obb3)]),
    setRay: dart.fnType(dart.void, [dart.legacy(vector_math_64.Ray), dart.legacy(core.double), dart.legacy(core.double)]),
    copyCenterAndHalfExtents: dart.fnType(dart.void, [dart.legacy(vector_math_64.Vector3), dart.legacy(vector_math_64.Vector3)]),
    copyCenter: dart.fnType(dart.void, [dart.legacy(vector_math_64.Vector3)]),
    copyFrom: dart.fnType(dart.void, [dart.legacy(vector_math_64.Aabb3)]),
    transform: dart.fnType(dart.void, [dart.legacy(vector_math_64.Matrix4)]),
    rotate: dart.fnType(dart.void, [dart.legacy(vector_math_64.Matrix4)]),
    transformed: dart.fnType(dart.legacy(vector_math_64.Aabb3), [dart.legacy(vector_math_64.Matrix4), dart.legacy(vector_math_64.Aabb3)]),
    rotated: dart.fnType(dart.legacy(vector_math_64.Aabb3), [dart.legacy(vector_math_64.Matrix4), dart.legacy(vector_math_64.Aabb3)]),
    getPN: dart.fnType(dart.void, [dart.legacy(vector_math_64.Vector3), dart.legacy(vector_math_64.Vector3), dart.legacy(vector_math_64.Vector3)]),
    hull: dart.fnType(dart.void, [dart.legacy(vector_math_64.Aabb3)]),
    hullPoint: dart.fnType(dart.void, [dart.legacy(vector_math_64.Vector3)]),
    containsAabb3: dart.fnType(dart.legacy(core.bool), [dart.legacy(vector_math_64.Aabb3)]),
    containsSphere: dart.fnType(dart.legacy(core.bool), [dart.legacy(vector_math_64.Sphere)]),
    containsVector3: dart.fnType(dart.legacy(core.bool), [dart.legacy(vector_math_64.Vector3)]),
    containsTriangle: dart.fnType(dart.legacy(core.bool), [dart.legacy(vector_math_64.Triangle)]),
    intersectsWithAabb3: dart.fnType(dart.legacy(core.bool), [dart.legacy(vector_math_64.Aabb3)]),
    intersectsWithSphere: dart.fnType(dart.legacy(core.bool), [dart.legacy(vector_math_64.Sphere)]),
    intersectsWithVector3: dart.fnType(dart.legacy(core.bool), [dart.legacy(vector_math_64.Vector3)]),
    intersectsWithTriangle: dart.fnType(dart.legacy(core.bool), [dart.legacy(vector_math_64.Triangle)], {epsilon: dart.legacy(core.double), result: dart.legacy(vector_math_64.IntersectionResult)}, {}),
    intersectsWithPlane: dart.fnType(dart.legacy(core.bool), [dart.legacy(vector_math_64.Plane)], {result: dart.legacy(vector_math_64.IntersectionResult)}, {}),
    intersectsWithQuad: dart.fnType(dart.legacy(core.bool), [dart.legacy(vector_math_64.Quad)], {result: dart.legacy(vector_math_64.IntersectionResult)}, {})
  }));
  dart.setGetterSignature(vector_math_64.Aabb3, () => ({
    __proto__: dart.getGetters(vector_math_64.Aabb3.__proto__),
    min: dart.legacy(vector_math_64.Vector3),
    max: dart.legacy(vector_math_64.Vector3),
    center: dart.legacy(vector_math_64.Vector3)
  }));
  dart.setLibraryUri(vector_math_64.Aabb3, L0);
  dart.setFieldSignature(vector_math_64.Aabb3, () => ({
    __proto__: dart.getFields(vector_math_64.Aabb3.__proto__),
    [_min]: dart.finalFieldType(dart.legacy(vector_math_64.Vector3)),
    [_max]: dart.finalFieldType(dart.legacy(vector_math_64.Vector3))
  }));
  ...
  vector_math_64.Colors = class Colors extends core.Object {
    ...
    static rgbToHsv(rgbColor, hsvColor) {
      let max = math.max(doubleL(), math.max(doubleL(), rgbColor.r, rgbColor.g), rgbColor.b);
      let min = math.min(doubleL(), math.min(doubleL(), rgbColor.r, rgbColor.g), rgbColor.b);
      let d = max - min;
      let v = max;
  ...
  dart.setLibraryUri(vector_math_64.Colors, L0);
  ...
  var _plane0 = dart.privateName(vector_math_64, "_plane0");
  var _plane1 = dart.privateName(vector_math_64, "_plane1");
  var _plane2 = dart.privateName(vector_math_64, "_plane2");
  var _plane3 = dart.privateName(vector_math_64, "_plane3");
  var _plane4 = dart.privateName(vector_math_64, "_plane4");
  var _plane5 = dart.privateName(vector_math_64, "_plane5");
  var _intersectsWithAabb3CheckPlane = dart.privateName(vector_math_64, "_intersectsWithAabb3CheckPlane");
  var _normal = dart.privateName(vector_math_64, "_normal");
  var _constant = dart.privateName(vector_math_64, "_constant");
  ...
  dart.setMethodSignature(vector_math_64.Frustum, () => ({
    ...
    copyFrom: dart.fnType(dart.void, [dart.legacy(vector_math_64.Frustum)]),
    setFromMatrix: dart.fnType(dart.void, [dart.legacy(vector_math_64.Matrix4)]),
    containsVector3: dart.fnType(dart.legacy(core.bool), [dart.legacy(vector_math_64.Vector3)]),
    intersectsWithAabb3: dart.fnType(dart.legacy(core.bool), [dart.legacy(vector_math_64.Aabb3)]),
    intersectsWithSphere: dart.fnType(dart.legacy(core.bool), [dart.legacy(vector_math_64.Sphere)]),
    calculateCorners: dart.fnType(dart.void, [dart.legacy(vector_math_64.Vector3), dart.legacy(vector_math_64.Vector3), dart.legacy(vector_math_64.Vector3), dart.legacy(vector_math_64.Vector3), dart.legacy(vector_math_64.Vector3), dart.legacy(vector_math_64.Vector3), dart.legacy(vector_math_64.Vector3), dart.legacy(vector_math_64.Vector3)]),
    [_intersectsWithAabb3CheckPlane]: dart.fnType(dart.legacy(core.bool), [dart.legacy(vector_math_64.Aabb3), dart.legacy(vector_math_64.Plane)])
  }));
  dart.setGetterSignature(vector_math_64.Frustum, () => ({
    __proto__: dart.getGetters(vector_math_64.Frustum.__proto__),
    plane0: dart.legacy(vector_math_64.Plane),
    plane1: dart.legacy(vector_math_64.Plane),
    plane2: dart.legacy(vector_math_64.Plane),
    plane3: dart.legacy(vector_math_64.Plane),
    plane4: dart.legacy(vector_math_64.Plane),
    plane5: dart.legacy(vector_math_64.Plane)
  }));
  dart.setLibraryUri(vector_math_64.Frustum, L0);
  dart.setFieldSignature(vector_math_64.Frustum, () => ({
    __proto__: dart.getFields(vector_math_64.Frustum.__proto__),
    [_plane0]: dart.finalFieldType(dart.legacy(vector_math_64.Plane)),
    [_plane1]: dart.finalFieldType(dart.legacy(vector_math_64.Plane)),
    [_plane2]: dart.finalFieldType(dart.legacy(vector_math_64.Plane)),
    [_plane3]: dart.finalFieldType(dart.legacy(vector_math_64.Plane)),
    [_plane4]: dart.finalFieldType(dart.legacy(vector_math_64.Plane)),
    [_plane5]: dart.finalFieldType(dart.legacy(vector_math_64.Plane))
  }));
  var axis = dart.privateName(vector_math_64, "IntersectionResult.axis");
  ...
  dart.setGetterSignature(vector_math_64.IntersectionResult, () => ({
    ...
    depth: dart.legacy(core.double)
  }));
  dart.setLibraryUri(vector_math_64.IntersectionResult, L0);
  dart.setFieldSignature(vector_math_64.IntersectionResult, () => ({
    ...
    [_depth]: dart.fieldType(dart.legacy(core.double)),
    axis: dart.finalFieldType(dart.legacy(vector_math_64.Vector3))
  }));
  var _m2storage = dart.privateName(vector_math_64, "_m2storage");
  var _v2storage$ = dart.privateName(vector_math_64, "_v2storage");
  vector_math_64.Matrix2 = class Matrix2 extends core.Object {
    ...
    entry(row, col) {
      if (!(dart.notNull(row) >= 0 && dart.notNull(row) < dart.notNull(this.dimension))) dart.assertFailed(null, L1, 39, 12, "(row >= 0) && (row < dimension)");
      if (!(dart.notNull(col) >= 0 && dart.notNull(col) < dart.notNull(this.dimension))) dart.assertFailed(null, L1, 40, 12, "(col >= 0) && (col < dimension)");
      return this[_m2storage][$_get](this.index(row, col));
    }
    setEntry(row, col, v) {
      if (!(dart.notNull(row) >= 0 && dart.notNull(row) < dart.notNull(this.dimension))) dart.assertFailed(null, L1, 47, 12, "(row >= 0) && (row < dimension)");
      if (!(dart.notNull(col) >= 0 && dart.notNull(col) < dart.notNull(this.dimension))) dart.assertFailed(null, L1, 48, 12, "(col >= 0) && (col < dimension)");
    ...
    _equals(other) {
      ...
      return Matrix2L().is(other) && this[_m2storage][$_get](0) == other[_m2storage][$_get](0) && this[_m2storage][$_get](1) == other[_m2storage][$_get](1) && this[_m2storage][$_get](2) == other[_m2storage][$_get](2) && this[_m2storage][$_get](3) == other[_m2storage][$_get](3);
    }
    get hashCode() {
  ...
  dart.setMethodSignature(vector_math_64.Matrix2, () => ({
    ...
    index: dart.fnType(dart.legacy(core.int), [dart.legacy(core.int), dart.legacy(core.int)]),
    entry: dart.fnType(dart.legacy(core.double), [dart.legacy(core.int), dart.legacy(core.int)]),
    setEntry: dart.fnType(dart.void, [dart.legacy(core.int), dart.legacy(core.int), dart.legacy(core.double)]),
    setValues: dart.fnType(dart.void, [dart.legacy(core.double), dart.legacy(core.double), dart.legacy(core.double), dart.legacy(core.double)]),
    setColumns: dart.fnType(dart.void, [dart.legacy(vector_math_64.Vector2), dart.legacy(vector_math_64.Vector2)]),
    setFrom: dart.fnType(dart.void, [dart.legacy(vector_math_64.Matrix2)]),
    setOuter: dart.fnType(dart.void, [dart.legacy(vector_math_64.Vector2), dart.legacy(vector_math_64.Vector2)]),
    splatDiagonal: dart.fnType(dart.void, [dart.legacy(core.double)]),
    setDiagonal: dart.fnType(dart.void, [dart.legacy(vector_math_64.Vector2)]),
    ...
    [$_equals]: dart.fnType(dart.legacy(core.bool), [dart.legacy(core.Object)]),
    setRow: dart.fnType(dart.void, [dart.legacy(core.int), dart.legacy(vector_math_64.Vector2)]),
    getRow: dart.fnType(dart.legacy(vector_math_64.Vector2), [dart.legacy(core.int)]),
    setColumn: dart.fnType(dart.void, [dart.legacy(core.int), dart.legacy(vector_math_64.Vector2)]),
    getColumn: dart.fnType(dart.legacy(vector_math_64.Vector2), [dart.legacy(core.int)]),
    clone: dart.fnType(dart.legacy(vector_math_64.Matrix2), []),
    copyInto: dart.fnType(dart.legacy(vector_math_64.Matrix2), [dart.legacy(vector_math_64.Matrix2)]),
    '*': dart.fnType(dart.dynamic, [dart.dynamic]),
    '+': dart.fnType(dart.legacy(vector_math_64.Matrix2), [dart.legacy(vector_math_64.Matrix2)]),
    '-': dart.fnType(dart.legacy(vector_math_64.Matrix2), [dart.legacy(vector_math_64.Matrix2)]),
    _negate: dart.fnType(dart.legacy(vector_math_64.Matrix2), []),
    setZero: dart.fnType(dart.void, []),
    setIdentity: dart.fnType(dart.void, []),
    transposed: dart.fnType(dart.legacy(vector_math_64.Matrix2), []),
    transpose: dart.fnType(dart.void, []),
    absolute: dart.fnType(dart.legacy(vector_math_64.Matrix2), []),
    determinant: dart.fnType(dart.legacy(core.double), []),
    dotRow: dart.fnType(dart.legacy(core.double), [dart.legacy(core.int), dart.legacy(vector_math_64.Vector2)]),
    dotColumn: dart.fnType(dart.legacy(core.double), [dart.legacy(core.int), dart.legacy(vector_math_64.Vector2)]),
    trace: dart.fnType(dart.legacy(core.double), []),
    infinityNorm: dart.fnType(dart.legacy(core.double), []),
    relativeError: dart.fnType(dart.legacy(core.double), [dart.legacy(vector_math_64.Matrix2)]),
    absoluteError: dart.fnType(dart.legacy(core.double), [dart.legacy(vector_math_64.Matrix2)]),
    invert: dart.fnType(dart.legacy(core.double), []),
    copyInverse: dart.fnType(dart.legacy(core.double), [dart.legacy(vector_math_64.Matrix2)]),
    setRotation: dart.fnType(dart.void, [dart.legacy(core.double)]),
    scaleAdjoint: dart.fnType(dart.void, [dart.legacy(core.double)]),
    scale: dart.fnType(dart.void, [dart.legacy(core.double)]),
    scaled: dart.fnType(dart.legacy(vector_math_64.Matrix2), [dart.legacy(core.double)]),
    add: dart.fnType(dart.void, [dart.legacy(vector_math_64.Matrix2)]),
    sub: dart.fnType(dart.void, [dart.legacy(vector_math_64.Matrix2)]),
    negate: dart.fnType(dart.void, []),
    multiply: dart.fnType(dart.void, [dart.legacy(vector_math_64.Matrix2)]),
    multiplied: dart.fnType(dart.legacy(vector_math_64.Matrix2), [dart.legacy(vector_math_64.Matrix2)]),
    transposeMultiply: dart.fnType(dart.void, [dart.legacy(vector_math_64.Matrix2)]),
    multiplyTranspose: dart.fnType(dart.void, [dart.legacy(vector_math_64.Matrix2)]),
    transform: dart.fnType(dart.legacy(vector_math_64.Vector2), [dart.legacy(vector_math_64.Vector2)]),
    transformed: dart.fnType(dart.legacy(vector_math_64.Vector2), [dart.legacy(vector_math_64.Vector2)], [dart.legacy(vector_math_64.Vector2)]),
    copyIntoArray: dart.fnType(dart.void, [dart.legacy(core.List$(dart.legacy(core.num)))], [dart.legacy(core.int)]),
    copyFromArray: dart.fnType(dart.void, [dart.legacy(core.List$(dart.legacy(core.double)))], [dart.legacy(core.int)])
  }));
  dart.setGetterSignature(vector_math_64.Matrix2, () => ({
    __proto__: dart.getGetters(vector_math_64.Matrix2.__proto__),
    storage: dart.legacy(typed_data.Float64List),
    dimension: dart.legacy(core.int),
    hashCode: dart.legacy(core.int),
    [$hashCode]: dart.legacy(core.int),
    row0: dart.legacy(vector_math_64.Vector2),
    row1: dart.legacy(vector_math_64.Vector2)
  }));
  ...
  dart.setLibraryUri(vector_math_64.Matrix2, L0);
  dart.setFieldSignature(vector_math_64.Matrix2, () => ({
    __proto__: dart.getFields(vector_math_64.Matrix2.__proto__),
    [_m2storage]: dart.finalFieldType(dart.legacy(typed_data.Float64List))
  }));
  ...
  var _m3storage = dart.privateName(vector_math_64, "_m3storage");
  var _v3storage$ = dart.privateName(vector_math_64, "_v3storage");
  vector_math_64.Matrix3 = class Matrix3 extends core.Object {
    ...
    entry(row, col) {
      if (!(dart.notNull(row) >= 0 && dart.notNull(row) < dart.notNull(this.dimension))) dart.assertFailed(null, L2, 87, 12, "(row >= 0) && (row < dimension)");
      if (!(dart.notNull(col) >= 0 && dart.notNull(col) < dart.notNull(this.dimension))) dart.assertFailed(null, L2, 88, 12, "(col >= 0) && (col < dimension)");
      return this[_m3storage][$_get](this.index(row, col));
    }
    setEntry(row, col, v) {
      if (!(dart.notNull(row) >= 0 && dart.notNull(row) < dart.notNull(this.dimension))) dart.assertFailed(null, L2, 95, 12, "(row >= 0) && (row < dimension)");
      if (!(dart.notNull(col) >= 0 && dart.notNull(col) < dart.notNull(this.dimension))) dart.assertFailed(null, L2, 96, 12, "(col >= 0) && (col < dimension)");
  ...
  dart.setMethodSignature(vector_math_64.Matrix3, () => ({
    ...
    entry: dart.fnType(dart.legacy(core.double), [dart.legacy(core.int), dart.legacy(core.int)]),
    setEntry: dart.fnType(dart.void, [dart.legacy(core.int), dart.legacy(core.int), dart.legacy(core.double)]),
    setValues: dart.fnType(dart.void, [dart.legacy(core.double), dart.legacy(core.double), dart.legacy(core.double), dart.legacy(core.double), dart.legacy(core.double), dart.legacy(core.double), dart.legacy(core.double), dart.legacy(core.double), dart.legacy(core.double)]),
    setColumns: dart.fnType(dart.void, [dart.legacy(vector_math_64.Vector3), dart.legacy(vector_math_64.Vector3), dart.legacy(vector_math_64.Vector3)]),
    setFrom: dart.fnType(dart.void, [dart.legacy(vector_math_64.Matrix3)]),
    setOuter: dart.fnType(dart.void, [dart.legacy(vector_math_64.Vector3), dart.legacy(vector_math_64.Vector3)]),
    splatDiagonal: dart.fnType(dart.void, [dart.legacy(core.double)]),
    setDiagonal: dart.fnType(dart.void, [dart.legacy(vector_math_64.Vector3)]),
    setUpper2x2: dart.fnType(dart.void, [dart.legacy(vector_math_64.Matrix2)]),
    toString: dart.fnType(dart.legacy(core.String), []),
    [$toString]: dart.fnType(dart.legacy(core.String), []),
    _get: dart.fnType(dart.legacy(core.double), [dart.legacy(core.int)]),
    _set: dart.fnType(dart.void, [dart.legacy(core.int), dart.legacy(core.double)]),
    _equals: dart.fnType(dart.legacy(core.bool), [dart.legacy(core.Object)]),
    [$_equals]: dart.fnType(dart.legacy(core.bool), [dart.legacy(core.Object)]),
    setRow: dart.fnType(dart.void, [dart.legacy(core.int), dart.legacy(vector_math_64.Vector3)]),
    getRow: dart.fnType(dart.legacy(vector_math_64.Vector3), [dart.legacy(core.int)]),
    setColumn: dart.fnType(dart.void, [dart.legacy(core.int), dart.legacy(vector_math_64.Vector3)]),
    getColumn: dart.fnType(dart.legacy(vector_math_64.Vector3), [dart.legacy(core.int)]),
    clone: dart.fnType(dart.legacy(vector_math_64.Matrix3), []),
    copyInto: dart.fnType(dart.legacy(vector_math_64.Matrix3), [dart.legacy(vector_math_64.Matrix3)]),
    '*': dart.fnType(dart.dynamic, [dart.dynamic]),
    '+': dart.fnType(dart.legacy(vector_math_64.Matrix3), [dart.legacy(vector_math_64.Matrix3)]),
    '-': dart.fnType(dart.legacy(vector_math_64.Matrix3), [dart.legacy(vector_math_64.Matrix3)]),
    _negate: dart.fnType(dart.legacy(vector_math_64.Matrix3), []),
    setZero: dart.fnType(dart.void, []),
    setIdentity: dart.fnType(dart.void, []),
    transposed: dart.fnType(dart.legacy(vector_math_64.Matrix3), []),
    transpose: dart.fnType(dart.void, []),
    absolute: dart.fnType(dart.legacy(vector_math_64.Matrix3), []),
    determinant: dart.fnType(dart.legacy(core.double), []),
    dotRow: dart.fnType(dart.legacy(core.double), [dart.legacy(core.int), dart.legacy(vector_math_64.Vector3)]),
    dotColumn: dart.fnType(dart.legacy(core.double), [dart.legacy(core.int), dart.legacy(vector_math_64.Vector3)]),
    trace: dart.fnType(dart.legacy(core.double), []),
    infinityNorm: dart.fnType(dart.legacy(core.double), []),
    relativeError: dart.fnType(dart.legacy(core.double), [dart.legacy(vector_math_64.Matrix3)]),
    absoluteError: dart.fnType(dart.legacy(core.double), [dart.legacy(vector_math_64.Matrix3)]),
    invert: dart.fnType(dart.legacy(core.double), []),
    copyInverse: dart.fnType(dart.legacy(core.double), [dart.legacy(vector_math_64.Matrix3)]),
    copyNormalMatrix: dart.fnType(dart.void, [dart.legacy(vector_math_64.Matrix4)]),
    setRotationX: dart.fnType(dart.void, [dart.legacy(core.double)]),
    setRotationY: dart.fnType(dart.void, [dart.legacy(core.double)]),
    setRotationZ: dart.fnType(dart.void, [dart.legacy(core.double)]),
    scaleAdjoint: dart.fnType(dart.void, [dart.legacy(core.double)]),
    absoluteRotate: dart.fnType(dart.legacy(vector_math_64.Vector3), [dart.legacy(vector_math_64.Vector3)]),
    absoluteRotate2: dart.fnType(dart.legacy(vector_math_64.Vector2), [dart.legacy(vector_math_64.Vector2)]),
    transform2: dart.fnType(dart.legacy(vector_math_64.Vector2), [dart.legacy(vector_math_64.Vector2)]),
    scale: dart.fnType(dart.void, [dart.legacy(core.double)]),
    scaled: dart.fnType(dart.legacy(vector_math_64.Matrix3), [dart.legacy(core.double)]),
    add: dart.fnType(dart.void, [dart.legacy(vector_math_64.Matrix3)]),
    sub: dart.fnType(dart.void, [dart.legacy(vector_math_64.Matrix3)]),
    negate: dart.fnType(dart.void, []),
    multiply: dart.fnType(dart.void, [dart.legacy(vector_math_64.Matrix3)]),
    multiplied: dart.fnType(dart.legacy(vector_math_64.Matrix3), [dart.legacy(vector_math_64.Matrix3)]),
    transposeMultiply: dart.fnType(dart.void, [dart.legacy(vector_math_64.Matrix3)]),
    multiplyTranspose: dart.fnType(dart.void, [dart.legacy(vector_math_64.Matrix3)]),
    transform: dart.fnType(dart.legacy(vector_math_64.Vector3), [dart.legacy(vector_math_64.Vector3)]),
    transformed: dart.fnType(dart.legacy(vector_math_64.Vector3), [dart.legacy(vector_math_64.Vector3)], [dart.legacy(vector_math_64.Vector3)]),
    copyIntoArray: dart.fnType(dart.void, [dart.legacy(core.List$(dart.legacy(core.num)))], [dart.legacy(core.int)]),
    copyFromArray: dart.fnType(dart.void, [dart.legacy(core.List$(dart.legacy(core.double)))], [dart.legacy(core.int)]),
    applyToVector3Array: dart.fnType(dart.legacy(core.List$(dart.legacy(core.double))), [dart.legacy(core.List$(dart.legacy(core.double)))], [dart.legacy(core.int)]),
    isIdentity: dart.fnType(dart.legacy(core.bool), []),
  ...
  dart.setGetterSignature(vector_math_64.Matrix3, () => ({
    ...
    hashCode: dart.legacy(core.int),
    [$hashCode]: dart.legacy(core.int),
    row0: dart.legacy(vector_math_64.Vector3),
    row1: dart.legacy(vector_math_64.Vector3),
    row2: dart.legacy(vector_math_64.Vector3),
    right: dart.legacy(vector_math_64.Vector3),
    up: dart.legacy(vector_math_64.Vector3),
    forward: dart.legacy(vector_math_64.Vector3)
  }));
  ...
  dart.setLibraryUri(vector_math_64.Matrix3, L0);
  dart.setFieldSignature(vector_math_64.Matrix3, () => ({
    __proto__: dart.getFields(vector_math_64.Matrix3.__proto__),
    [_m3storage]: dart.finalFieldType(dart.legacy(typed_data.Float64List))
  }));
  ...
  var _m4storage$ = dart.privateName(vector_math_64, "_m4storage");
  var _v4storage$ = dart.privateName(vector_math_64, "_v4storage");
  var _qStorage$ = dart.privateName(vector_math_64, "_qStorage");
  vector_math_64.Matrix4 = class Matrix4 extends core.Object {
    ...
    entry(row, col) {
      if (!(dart.notNull(row) >= 0 && dart.notNull(row) < dart.notNull(this.dimension))) dart.assertFailed(null, L3, 167, 12, "(row >= 0) && (row < dimension)");
      if (!(dart.notNull(col) >= 0 && dart.notNull(col) < dart.notNull(this.dimension))) dart.assertFailed(null, L3, 168, 12, "(col >= 0) && (col < dimension)");
      return this[_m4storage$][$_get](this.index(row, col));
    }
    setEntry(row, col, v) {
      if (!(dart.notNull(row) >= 0 && dart.notNull(row) < dart.notNull(this.dimension))) dart.assertFailed(null, L3, 175, 12, "(row >= 0) && (row < dimension)");
      if (!(dart.notNull(col) >= 0 && dart.notNull(col) < dart.notNull(this.dimension))) dart.assertFailed(null, L3, 176, 12, "(col >= 0) && (col < dimension)");
    ...
    translate(x, y = 0, z = 0) {
      ...
      let ty = null;
      let tz = null;
      let tw = Vector4L().is(x) ? x.w : 1.0;
      if (Vector3L().is(x)) {
        tx = x.x;
        ty = x.y;
        tz = x.z;
      } else if (Vector4L().is(x)) {
        tx = x.x;
        ty = x.y;
        tz = x.z;
      } else if (doubleL().is(x)) {
        tx = x;
        ty = y;
        tz = z;
      }
    ...
    getMaxScaleOnAxis() {
      ...
      return math.sqrt(math.max(numL(), scaleXSq, math.max(numL(), scaleYSq, scaleZSq)));
    }
    transposeRotation() {
      let temp = null;
    ...
    decompose(translation, rotation, scale) {
      ...
      let sx = (t0 = v, (() => {
        t0.setValues(this[_m4storage$][$_get](0), this[_m4storage$][$_get](1), this[_m4storage$][$_get](2));
        return t0;
      })()).length;
      let sy = (t0$ = v, (() => {
        t0$.setValues(this[_m4storage$][$_get](4), this[_m4storage$][$_get](5), this[_m4storage$][$_get](6));
        return t0$;
      })()).length;
      let sz = (t0$0 = v, (() => {
        t0$0.setValues(this[_m4storage$][$_get](8), this[_m4storage$][$_get](9), this[_m4storage$][$_get](10));
        return t0$0;
      })()).length;
  ...
  dart.setMethodSignature(vector_math_64.Matrix4, () => ({
    ...
    setEntry: dart.fnType(dart.void, [dart.legacy(core.int), dart.legacy(core.int), dart.legacy(core.double)]),
    splatDiagonal: dart.fnType(dart.void, [dart.legacy(core.double)]),
    setValues: dart.fnType(dart.void, [dart.legacy(core.double), dart.legacy(core.double), dart.legacy(core.double), dart.legacy(core.double), dart.legacy(core.double), dart.legacy(core.double), dart.legacy(core.double), dart.legacy(core.double), dart.legacy(core.double), dart.legacy(core.double), dart.legacy(core.double), dart.legacy(core.double), dart.legacy(core.double), dart.legacy(core.double), dart.legacy(core.double), dart.legacy(core.double)]),
    setColumns: dart.fnType(dart.void, [dart.legacy(vector_math_64.Vector4), dart.legacy(vector_math_64.Vector4), dart.legacy(vector_math_64.Vector4), dart.legacy(vector_math_64.Vector4)]),
    setFrom: dart.fnType(dart.void, [dart.legacy(vector_math_64.Matrix4)]),
    setFromTranslationRotation: dart.fnType(dart.void, [dart.legacy(vector_math_64.Vector3), dart.legacy(vector_math_64.Quaternion)]),
    setFromTranslationRotationScale: dart.fnType(dart.void, [dart.legacy(vector_math_64.Vector3), dart.legacy(vector_math_64.Quaternion), dart.legacy(vector_math_64.Vector3)]),
    setUpper2x2: dart.fnType(dart.void, [dart.legacy(vector_math_64.Matrix2)]),
    setDiagonal: dart.fnType(dart.void, [dart.legacy(vector_math_64.Vector4)]),
    setOuter: dart.fnType(dart.void, [dart.legacy(vector_math_64.Vector4), dart.legacy(vector_math_64.Vector4)]),
    toString: dart.fnType(dart.legacy(core.String), []),
    [$toString]: dart.fnType(dart.legacy(core.String), []),
    _get: dart.fnType(dart.legacy(core.double), [dart.legacy(core.int)]),
    _set: dart.fnType(dart.void, [dart.legacy(core.int), dart.legacy(core.double)]),
    _equals: dart.fnType(dart.legacy(core.bool), [dart.legacy(core.Object)]),
    [$_equals]: dart.fnType(dart.legacy(core.bool), [dart.legacy(core.Object)]),
    setRow: dart.fnType(dart.void, [dart.legacy(core.int), dart.legacy(vector_math_64.Vector4)]),
    getRow: dart.fnType(dart.legacy(vector_math_64.Vector4), [dart.legacy(core.int)]),
    setColumn: dart.fnType(dart.void, [dart.legacy(core.int), dart.legacy(vector_math_64.Vector4)]),
    getColumn: dart.fnType(dart.legacy(vector_math_64.Vector4), [dart.legacy(core.int)]),
    clone: dart.fnType(dart.legacy(vector_math_64.Matrix4), []),
    copyInto: dart.fnType(dart.legacy(vector_math_64.Matrix4), [dart.legacy(vector_math_64.Matrix4)]),
    _negate: dart.fnType(dart.legacy(vector_math_64.Matrix4), []),
    '*': dart.fnType(dart.dynamic, [dart.dynamic]),
    '+': dart.fnType(dart.legacy(vector_math_64.Matrix4), [dart.legacy(vector_math_64.Matrix4)]),
    '-': dart.fnType(dart.legacy(vector_math_64.Matrix4), [dart.legacy(vector_math_64.Matrix4)]),
    translate: dart.fnType(dart.void, [dart.dynamic], [dart.legacy(core.double), dart.legacy(core.double)]),
    leftTranslate: dart.fnType(dart.void, [dart.dynamic], [dart.legacy(core.double), dart.legacy(core.double)]),
    rotate: dart.fnType(dart.void, [dart.legacy(vector_math_64.Vector3), dart.legacy(core.double)]),
    ...
    scale: dart.fnType(dart.void, [dart.dynamic], [dart.legacy(core.double), dart.legacy(core.double)]),
    scaled: dart.fnType(dart.legacy(vector_math_64.Matrix4), [dart.dynamic], [dart.legacy(core.double), dart.legacy(core.double)]),
    setZero: dart.fnType(dart.void, []),
    setIdentity: dart.fnType(dart.void, []),
    transposed: dart.fnType(dart.legacy(vector_math_64.Matrix4), []),
    transpose: dart.fnType(dart.void, []),
    absolute: dart.fnType(dart.legacy(vector_math_64.Matrix4), []),
    determinant: dart.fnType(dart.legacy(core.double), []),
    dotRow: dart.fnType(dart.legacy(core.double), [dart.legacy(core.int), dart.legacy(vector_math_64.Vector4)]),
    dotColumn: dart.fnType(dart.legacy(core.double), [dart.legacy(core.int), dart.legacy(vector_math_64.Vector4)]),
    trace: dart.fnType(dart.legacy(core.double), []),
    infinityNorm: dart.fnType(dart.legacy(core.double), []),
    relativeError: dart.fnType(dart.legacy(core.double), [dart.legacy(vector_math_64.Matrix4)]),
    absoluteError: dart.fnType(dart.legacy(core.double), [dart.legacy(vector_math_64.Matrix4)]),
    getTranslation: dart.fnType(dart.legacy(vector_math_64.Vector3), []),
    setTranslation: dart.fnType(dart.void, [dart.legacy(vector_math_64.Vector3)]),
    setTranslationRaw: dart.fnType(dart.void, [dart.legacy(core.double), dart.legacy(core.double), dart.legacy(core.double)]),
    getRotation: dart.fnType(dart.legacy(vector_math_64.Matrix3), []),
    copyRotation: dart.fnType(dart.void, [dart.legacy(vector_math_64.Matrix3)]),
    setRotation: dart.fnType(dart.void, [dart.legacy(vector_math_64.Matrix3)]),
    getNormalMatrix: dart.fnType(dart.legacy(vector_math_64.Matrix3), []),
    getMaxScaleOnAxis: dart.fnType(dart.legacy(core.double), []),
    transposeRotation: dart.fnType(dart.void, []),
    invert: dart.fnType(dart.legacy(core.double), []),
    copyInverse: dart.fnType(dart.legacy(core.double), [dart.legacy(vector_math_64.Matrix4)]),
    invertRotation: dart.fnType(dart.legacy(core.double), []),
    setRotationX: dart.fnType(dart.void, [dart.legacy(core.double)]),
    setRotationY: dart.fnType(dart.void, [dart.legacy(core.double)]),
    setRotationZ: dart.fnType(dart.void, [dart.legacy(core.double)]),
    scaleAdjoint: dart.fnType(dart.void, [dart.legacy(core.double)]),
    absoluteRotate: dart.fnType(dart.legacy(vector_math_64.Vector3), [dart.legacy(vector_math_64.Vector3)]),
    add: dart.fnType(dart.void, [dart.legacy(vector_math_64.Matrix4)]),
    sub: dart.fnType(dart.void, [dart.legacy(vector_math_64.Matrix4)]),
    negate: dart.fnType(dart.void, []),
    multiply: dart.fnType(dart.void, [dart.legacy(vector_math_64.Matrix4)]),
    multiplied: dart.fnType(dart.legacy(vector_math_64.Matrix4), [dart.legacy(vector_math_64.Matrix4)]),
    transposeMultiply: dart.fnType(dart.void, [dart.legacy(vector_math_64.Matrix4)]),
    multiplyTranspose: dart.fnType(dart.void, [dart.legacy(vector_math_64.Matrix4)]),
    decompose: dart.fnType(dart.void, [dart.legacy(vector_math_64.Vector3), dart.legacy(vector_math_64.Quaternion), dart.legacy(vector_math_64.Vector3)]),
    rotate3: dart.fnType(dart.legacy(vector_math_64.Vector3), [dart.legacy(vector_math_64.Vector3)]),
    rotated3: dart.fnType(dart.legacy(vector_math_64.Vector3), [dart.legacy(vector_math_64.Vector3)], [dart.legacy(vector_math_64.Vector3)]),
    transform3: dart.fnType(dart.legacy(vector_math_64.Vector3), [dart.legacy(vector_math_64.Vector3)]),
    transformed3: dart.fnType(dart.legacy(vector_math_64.Vector3), [dart.legacy(vector_math_64.Vector3)], [dart.legacy(vector_math_64.Vector3)]),
    transform: dart.fnType(dart.legacy(vector_math_64.Vector4), [dart.legacy(vector_math_64.Vector4)]),
    perspectiveTransform: dart.fnType(dart.legacy(vector_math_64.Vector3), [dart.legacy(vector_math_64.Vector3)]),
    transformed: dart.fnType(dart.legacy(vector_math_64.Vector4), [dart.legacy(vector_math_64.Vector4)], [dart.legacy(vector_math_64.Vector4)]),
    copyIntoArray: dart.fnType(dart.void, [dart.legacy(core.List$(dart.legacy(core.num)))], [dart.legacy(core.int)]),
    copyFromArray: dart.fnType(dart.void, [dart.legacy(core.List$(dart.legacy(core.double)))], [dart.legacy(core.int)]),
    applyToVector3Array: dart.fnType(dart.legacy(core.List$(dart.legacy(core.double))), [dart.legacy(core.List$(dart.legacy(core.double)))], [dart.legacy(core.int)]),
    isIdentity: dart.fnType(dart.legacy(core.bool), []),
  ...
  dart.setGetterSignature(vector_math_64.Matrix4, () => ({
    ...
    hashCode: dart.legacy(core.int),
    [$hashCode]: dart.legacy(core.int),
    row0: dart.legacy(vector_math_64.Vector4),
    row1: dart.legacy(vector_math_64.Vector4),
    row2: dart.legacy(vector_math_64.Vector4),
    row3: dart.legacy(vector_math_64.Vector4),
    right: dart.legacy(vector_math_64.Vector3),
    up: dart.legacy(vector_math_64.Vector3),
    forward: dart.legacy(vector_math_64.Vector3)
  }));
  ...
  dart.setLibraryUri(vector_math_64.Matrix4, L0);
  dart.setFieldSignature(vector_math_64.Matrix4, () => ({
    __proto__: dart.getFields(vector_math_64.Matrix4.__proto__),
    [_m4storage$]: dart.finalFieldType(dart.legacy(typed_data.Float64List))
  }));
  ...
  var _halfExtents = dart.privateName(vector_math_64, "_halfExtents");
  var _axis0 = dart.privateName(vector_math_64, "_axis0");
  var _axis1 = dart.privateName(vector_math_64, "_axis1");
  var _axis2 = dart.privateName(vector_math_64, "_axis2");
  vector_math_64.Obb3 = class Obb3 extends core.Object {
    ...
    rotate(t) {
      ...
      t0 = t;
      (() => {
        t0.transform((t1 = this[_axis0], (() => {
          t1.scale(this[_halfExtents].x);
          return t1;
        })()));
        t0.transform((t1$ = this[_axis1], (() => {
          t1$.scale(this[_halfExtents].y);
          return t1$;
        })()));
        t0.transform((t1$0 = this[_axis2], (() => {
          t1$0.scale(this[_halfExtents].z);
          return t1$0;
        })()));
        return t0;
      })();
    ...
    transform(t) {
      ...
      (() => {
        ...
        t0.rotate3((t1 = this[_axis0], (() => {
          t1.scale(this[_halfExtents].x);
          return t1;
        })()));
        t0.rotate3((t1$ = this[_axis1], (() => {
          t1$.scale(this[_halfExtents].y);
          return t1$;
        })()));
        t0.rotate3((t1$0 = this[_axis2], (() => {
          t1$0.scale(this[_halfExtents].z);
          return t1$0;
        })()));
        return t0;
    ...
    copyCorner(cornerIndex, corner) {
      ...
      if (!(dart.notNull(cornerIndex) >= 0 || dart.notNull(cornerIndex) < 8)) dart.assertFailed(null, L4, 114, 12, "cornerIndex >= 0 || cornerIndex < 8");
  ...
  dart.setMethodSignature(vector_math_64.Obb3, () => ({
    ...
    copyFrom: dart.fnType(dart.void, [dart.legacy(vector_math_64.Obb3)]),
    copyInto: dart.fnType(dart.void, [dart.legacy(vector_math_64.Obb3)]),
    resetRotation: dart.fnType(dart.void, []),
    translate: dart.fnType(dart.void, [dart.legacy(vector_math_64.Vector3)]),
    rotate: dart.fnType(dart.void, [dart.legacy(vector_math_64.Matrix3)]),
    transform: dart.fnType(dart.void, [dart.legacy(vector_math_64.Matrix4)]),
    copyCorner: dart.fnType(dart.void, [dart.legacy(core.int), dart.legacy(vector_math_64.Vector3)]),
    closestPointTo: dart.fnType(dart.void, [dart.legacy(vector_math_64.Vector3), dart.legacy(vector_math_64.Vector3)]),
    intersectsWithObb3: dart.fnType(dart.legacy(core.bool), [dart.legacy(vector_math_64.Obb3)], [dart.legacy(core.double)]),
    intersectsWithTriangle: dart.fnType(dart.legacy(core.bool), [dart.legacy(vector_math_64.Triangle)], {result: dart.legacy(vector_math_64.IntersectionResult)}, {}),
    intersectsWithVector3: dart.fnType(dart.legacy(core.bool), [dart.legacy(vector_math_64.Vector3)]),
    intersectsWithQuad: dart.fnType(dart.legacy(core.bool), [dart.legacy(vector_math_64.Quad)], {result: dart.legacy(vector_math_64.IntersectionResult)}, {})
  }));
  dart.setGetterSignature(vector_math_64.Obb3, () => ({
    ...
    center: dart.legacy(vector_math_64.Vector3),
    halfExtents: dart.legacy(vector_math_64.Vector3),
    axis0: dart.legacy(vector_math_64.Vector3),
    axis1: dart.legacy(vector_math_64.Vector3),
    axis2: dart.legacy(vector_math_64.Vector3)
  }));
  dart.setLibraryUri(vector_math_64.Obb3, L0);
  dart.setFieldSignature(vector_math_64.Obb3, () => ({
    __proto__: dart.getFields(vector_math_64.Obb3.__proto__),
    [_center]: dart.finalFieldType(dart.legacy(vector_math_64.Vector3)),
    [_halfExtents]: dart.finalFieldType(dart.legacy(vector_math_64.Vector3)),
    [_axis0]: dart.finalFieldType(dart.legacy(vector_math_64.Vector3)),
    [_axis1]: dart.finalFieldType(dart.legacy(vector_math_64.Vector3)),
    [_axis2]: dart.finalFieldType(dart.legacy(vector_math_64.Vector3))
  }));
  ...
  dart.setMethodSignature(vector_math_64.Plane, () => ({
    ...
    copyFrom: dart.fnType(dart.void, [dart.legacy(vector_math_64.Plane)]),
    setFromComponents: dart.fnType(dart.void, [dart.legacy(core.double), dart.legacy(core.double), dart.legacy(core.double), dart.legacy(core.double)]),
    normalize: dart.fnType(dart.void, []),
    distanceToVector3: dart.fnType(dart.legacy(core.double), [dart.legacy(vector_math_64.Vector3)])
  }));
  dart.setGetterSignature(vector_math_64.Plane, () => ({
    __proto__: dart.getGetters(vector_math_64.Plane.__proto__),
    normal: dart.legacy(vector_math_64.Vector3),
    constant: dart.legacy(core.double)
  }));
  dart.setSetterSignature(vector_math_64.Plane, () => ({
    __proto__: dart.getSetters(vector_math_64.Plane.__proto__),
    constant: dart.legacy(core.double)
  }));
  dart.setLibraryUri(vector_math_64.Plane, L0);
  dart.setFieldSignature(vector_math_64.Plane, () => ({
    __proto__: dart.getFields(vector_math_64.Plane.__proto__),
    [_normal]: dart.finalFieldType(dart.legacy(vector_math_64.Vector3)),
    [_constant]: dart.fieldType(dart.legacy(core.double))
  }));
  ...
  dart.setMethodSignature(vector_math_64.Quad, () => ({
    ...
    copyFrom: dart.fnType(dart.void, [dart.legacy(vector_math_64.Quad)]),
    copyNormalInto: dart.fnType(dart.void, [dart.legacy(vector_math_64.Vector3)]),
    copyTriangles: dart.fnType(dart.void, [dart.legacy(vector_math_64.Triangle), dart.legacy(vector_math_64.Triangle)]),
    transform: dart.fnType(dart.void, [dart.legacy(vector_math_64.Matrix4)]),
    translate: dart.fnType(dart.void, [dart.legacy(vector_math_64.Vector3)])
  }));
  dart.setGetterSignature(vector_math_64.Quad, () => ({
    __proto__: dart.getGetters(vector_math_64.Quad.__proto__),
    point0: dart.legacy(vector_math_64.Vector3),
    point1: dart.legacy(vector_math_64.Vector3),
    point2: dart.legacy(vector_math_64.Vector3),
    point3: dart.legacy(vector_math_64.Vector3)
  }));
  dart.setLibraryUri(vector_math_64.Quad, L0);
  dart.setFieldSignature(vector_math_64.Quad, () => ({
    __proto__: dart.getFields(vector_math_64.Quad.__proto__),
    [_point0]: dart.finalFieldType(dart.legacy(vector_math_64.Vector3)),
    [_point1]: dart.finalFieldType(dart.legacy(vector_math_64.Vector3)),
    [_point2]: dart.finalFieldType(dart.legacy(vector_math_64.Vector3)),
    [_point3]: dart.finalFieldType(dart.legacy(vector_math_64.Vector3))
  }));
  vector_math_64.Quaternion = class Quaternion extends core.Object {
    ...
    copyRotationInto(rotationMatrix) {
      let d = this.length2;
      if (!(d !== 0.0)) dart.assertFailed(null, L5, 420, 12, "d != 0.0");
  ...
  dart.setMethodSignature(vector_math_64.Quaternion, () => ({
    ...
    clone: dart.fnType(dart.legacy(vector_math_64.Quaternion), []),
    setFrom: dart.fnType(dart.void, [dart.legacy(vector_math_64.Quaternion)]),
    setValues: dart.fnType(dart.void, [dart.legacy(core.double), dart.legacy(core.double), dart.legacy(core.double), dart.legacy(core.double)]),
    setAxisAngle: dart.fnType(dart.void, [dart.legacy(vector_math_64.Vector3), dart.legacy(core.double)]),
    setFromRotation: dart.fnType(dart.void, [dart.legacy(vector_math_64.Matrix3)]),
    setFromTwoVectors: dart.fnType(dart.void, [dart.legacy(vector_math_64.Vector3), dart.legacy(vector_math_64.Vector3)]),
    setRandom: dart.fnType(dart.void, [dart.legacy(math.Random)]),
    setDQ: dart.fnType(dart.void, [dart.legacy(vector_math_64.Quaternion), dart.legacy(vector_math_64.Vector3)]),
    setEuler: dart.fnType(dart.void, [dart.legacy(core.double), dart.legacy(core.double), dart.legacy(core.double)]),
    normalize: dart.fnType(dart.legacy(core.double), []),
    conjugate: dart.fnType(dart.void, []),
    inverse: dart.fnType(dart.void, []),
    normalized: dart.fnType(dart.legacy(vector_math_64.Quaternion), []),
    conjugated: dart.fnType(dart.legacy(vector_math_64.Quaternion), []),
    inverted: dart.fnType(dart.legacy(vector_math_64.Quaternion), []),
    rotated: dart.fnType(dart.legacy(vector_math_64.Vector3), [dart.legacy(vector_math_64.Vector3)]),
    rotate: dart.fnType(dart.legacy(vector_math_64.Vector3), [dart.legacy(vector_math_64.Vector3)]),
    add: dart.fnType(dart.void, [dart.legacy(vector_math_64.Quaternion)]),
    sub: dart.fnType(dart.void, [dart.legacy(vector_math_64.Quaternion)]),
    scale: dart.fnType(dart.void, [dart.legacy(core.double)]),
    scaled: dart.fnType(dart.legacy(vector_math_64.Quaternion), [dart.legacy(core.double)]),
    '*': dart.fnType(dart.legacy(vector_math_64.Quaternion), [dart.legacy(vector_math_64.Quaternion)]),
    '+': dart.fnType(dart.legacy(vector_math_64.Quaternion), [dart.legacy(vector_math_64.Quaternion)]),
    '-': dart.fnType(dart.legacy(vector_math_64.Quaternion), [dart.legacy(vector_math_64.Quaternion)]),
    _negate: dart.fnType(dart.legacy(vector_math_64.Quaternion), []),
    _get: dart.fnType(dart.legacy(core.double), [dart.legacy(core.int)]),
    _set: dart.fnType(dart.void, [dart.legacy(core.int), dart.legacy(core.double)]),
    asRotationMatrix: dart.fnType(dart.legacy(vector_math_64.Matrix3), []),
    copyRotationInto: dart.fnType(dart.legacy(vector_math_64.Matrix3), [dart.legacy(vector_math_64.Matrix3)]),
    toString: dart.fnType(dart.legacy(core.String), []),
    [$toString]: dart.fnType(dart.legacy(core.String), []),
    relativeError: dart.fnType(dart.legacy(core.double), [dart.legacy(vector_math_64.Quaternion)]),
    absoluteError: dart.fnType(dart.legacy(core.double), [dart.legacy(vector_math_64.Quaternion)])
  }));
  dart.setGetterSignature(vector_math_64.Quaternion, () => ({
    ...
    z: dart.legacy(core.double),
    w: dart.legacy(core.double),
    radians: dart.legacy(core.double),
    axis: dart.legacy(vector_math_64.Vector3),
    length2: dart.legacy(core.double),
    length: dart.legacy(core.double)
  }));
  ...
  dart.setLibraryUri(vector_math_64.Quaternion, L0);
  dart.setFieldSignature(vector_math_64.Quaternion, () => ({
    __proto__: dart.getFields(vector_math_64.Quaternion.__proto__),
    [_qStorage$]: dart.finalFieldType(dart.legacy(typed_data.Float64List))
  }));
  dart.defineExtensionMethods(vector_math_64.Quaternion, ['toString']);
  var _origin = dart.privateName(vector_math_64, "_origin");
  var _direction = dart.privateName(vector_math_64, "_direction");
  ...
  dart.setMethodSignature(vector_math_64.Ray, () => ({
    ...
    copyFrom: dart.fnType(dart.void, [dart.legacy(vector_math_64.Ray)]),
    at: dart.fnType(dart.legacy(vector_math_64.Vector3), [dart.legacy(core.double)]),
    copyAt: dart.fnType(dart.void, [dart.legacy(vector_math_64.Vector3), dart.legacy(core.double)]),
    intersectsWithSphere: dart.fnType(dart.legacy(core.double), [dart.legacy(vector_math_64.Sphere)]),
    intersectsWithTriangle: dart.fnType(dart.legacy(core.double), [dart.legacy(vector_math_64.Triangle)]),
    intersectsWithQuad: dart.fnType(dart.legacy(core.double), [dart.legacy(vector_math_64.Quad)]),
    intersectsWithAabb3: dart.fnType(dart.legacy(core.double), [dart.legacy(vector_math_64.Aabb3)])
  }));
  dart.setGetterSignature(vector_math_64.Ray, () => ({
    __proto__: dart.getGetters(vector_math_64.Ray.__proto__),
    origin: dart.legacy(vector_math_64.Vector3),
    direction: dart.legacy(vector_math_64.Vector3)
  }));
  dart.setLibraryUri(vector_math_64.Ray, L0);
  dart.setFieldSignature(vector_math_64.Ray, () => ({
    __proto__: dart.getFields(vector_math_64.Ray.__proto__),
    [_origin]: dart.finalFieldType(dart.legacy(vector_math_64.Vector3)),
    [_direction]: dart.finalFieldType(dart.legacy(vector_math_64.Vector3))
  }));
  ...
  dart.setMethodSignature(vector_math_64.Sphere, () => ({
    ...
    copyFrom: dart.fnType(dart.void, [dart.legacy(vector_math_64.Sphere)]),
    containsVector3: dart.fnType(dart.legacy(core.bool), [dart.legacy(vector_math_64.Vector3)]),
    intersectsWithVector3: dart.fnType(dart.legacy(core.bool), [dart.legacy(vector_math_64.Vector3)]),
    intersectsWithSphere: dart.fnType(dart.legacy(core.bool), [dart.legacy(vector_math_64.Sphere)])
  }));
  ...
  dart.setLibraryUri(vector_math_64.Sphere, L0);
  ...
  var _perm = dart.privateName(vector_math_64, "_perm");
  var _permMod12 = dart.privateName(vector_math_64, "_permMod12");
  var _dot2 = dart.privateName(vector_math_64, "_dot2");
  var _dot3 = dart.privateName(vector_math_64, "_dot3");
  var _dot4 = dart.privateName(vector_math_64, "_dot4");
  ...
  (vector_math_64.SimplexNoise.new = function(r = null) {
    ...
    let p = ListOfintL().generate(256, dart.fn(_ => r.nextInt(256), intLTointL()), {growable: false});
    this[_perm] = ListOfintL().generate(dart.notNull(p[$length]) * 2, dart.fn(i => p[$_get](i[$modulo](p[$length])), intLTointL()), {growable: false});
    this[_permMod12] = ListOfintL().generate(this[_perm][$length], dart.fn(i => this[_perm][$_get](i)[$modulo](12), intLTointL()), {growable: false});
  ...
  dart.setMethodSignature(vector_math_64.SimplexNoise, () => ({
    ...
    [_dot2]: dart.fnType(dart.legacy(core.double), [dart.legacy(core.List$(dart.legacy(core.double))), dart.legacy(core.double), dart.legacy(core.double)]),
    [_dot3]: dart.fnType(dart.legacy(core.double), [dart.legacy(core.List$(dart.legacy(core.double))), dart.legacy(core.double), dart.legacy(core.double), dart.legacy(core.double)]),
    [_dot4]: dart.fnType(dart.legacy(core.double), [dart.legacy(core.List$(dart.legacy(core.double))), dart.legacy(core.double), dart.legacy(core.double), dart.legacy(core.double), dart.legacy(core.double)]),
    noise2D: dart.fnType(dart.legacy(core.double), [dart.legacy(core.double), dart.legacy(core.double)]),
    noise3D: dart.fnType(dart.legacy(core.double), [dart.legacy(core.double), dart.legacy(core.double), dart.legacy(core.double)]),
    noise4D: dart.fnType(dart.legacy(core.double), [dart.legacy(core.double), dart.legacy(core.double), dart.legacy(core.double), dart.legacy(core.double)])
  }));
  dart.setLibraryUri(vector_math_64.SimplexNoise, L0);
  dart.setFieldSignature(vector_math_64.SimplexNoise, () => ({
    __proto__: dart.getFields(vector_math_64.SimplexNoise.__proto__),
    [_perm]: dart.fieldType(dart.legacy(core.List$(dart.legacy(core.int)))),
    [_permMod12]: dart.fieldType(dart.legacy(core.List$(dart.legacy(core.int))))
  }));
  dart.defineLazy(vector_math_64.SimplexNoise, {
    /*vector_math_64.SimplexNoise._grad3*/get _grad3() {
      return JSArrayOfListLOfdoubleL().of([JSArrayOfdoubleL().of([1.0, 1.0, 0.0]), JSArrayOfdoubleL().of([-1.0, 1.0, 0.0]), JSArrayOfdoubleL().of([1.0, -1.0, 0.0]), JSArrayOfdoubleL().of([-1.0, -1.0, 0.0]), JSArrayOfdoubleL().of([1.0, 0.0, 1.0]), JSArrayOfdoubleL().of([-1.0, 0.0, 1.0]), JSArrayOfdoubleL().of([1.0, 0.0, -1.0]), JSArrayOfdoubleL().of([-1.0, 0.0, -1.0]), JSArrayOfdoubleL().of([0.0, 1.0, 1.0]), JSArrayOfdoubleL().of([0.0, -1.0, 1.0]), JSArrayOfdoubleL().of([0.0, 1.0, -1.0]), JSArrayOfdoubleL().of([0.0, -1.0, -1.0])]);
    },
    /*vector_math_64.SimplexNoise._grad4*/get _grad4() {
      return JSArrayOfListLOfdoubleL().of([JSArrayOfdoubleL().of([0.0, 1.0, 1.0, 1.0]), JSArrayOfdoubleL().of([0.0, 1.0, 1.0, -1.0]), JSArrayOfdoubleL().of([0.0, 1.0, -1.0, 1.0]), JSArrayOfdoubleL().of([0.0, 1.0, -1.0, -1.0]), JSArrayOfdoubleL().of([0.0, -1.0, 1.0, 1.0]), JSArrayOfdoubleL().of([0.0, -1.0, 1.0, -1.0]), JSArrayOfdoubleL().of([0.0, -1.0, -1.0, 1.0]), JSArrayOfdoubleL().of([0.0, -1.0, -1.0, -1.0]), JSArrayOfdoubleL().of([1.0, 0.0, 1.0, 1.0]), JSArrayOfdoubleL().of([1.0, 0.0, 1.0, -1.0]), JSArrayOfdoubleL().of([1.0, 0.0, -1.0, 1.0]), JSArrayOfdoubleL().of([1.0, 0.0, -1.0, -1.0]), JSArrayOfdoubleL().of([-1.0, 0.0, 1.0, 1.0]), JSArrayOfdoubleL().of([-1.0, 0.0, 1.0, -1.0]), JSArrayOfdoubleL().of([-1.0, 0.0, -1.0, 1.0]), JSArrayOfdoubleL().of([-1.0, 0.0, -1.0, -1.0]), JSArrayOfdoubleL().of([1.0, 1.0, 0.0, 1.0]), JSArrayOfdoubleL().of([1.0, 1.0, 0.0, -1.0]), JSArrayOfdoubleL().of([1.0, -1.0, 0.0, 1.0]), JSArrayOfdoubleL().of([1.0, -1.0, 0.0, -1.0]), JSArrayOfdoubleL().of([-1.0, 1.0, 0.0, 1.0]), JSArrayOfdoubleL().of([-1.0, 1.0, 0.0, -1.0]), JSArrayOfdoubleL().of([-1.0, -1.0, 0.0, 1.0]), JSArrayOfdoubleL().of([-1.0, -1.0, 0.0, -1.0]), JSArrayOfdoubleL().of([1.0, 1.0, 1.0, 0.0]), JSArrayOfdoubleL().of([1.0, 1.0, -1.0, 0.0]), JSArrayOfdoubleL().of([1.0, -1.0, 1.0, 0.0]), JSArrayOfdoubleL().of([1.0, -1.0, -1.0, 0.0]), JSArrayOfdoubleL().of([-1.0, 1.0, 1.0, 0.0]), JSArrayOfdoubleL().of([-1.0, 1.0, -1.0, 0.0]), JSArrayOfdoubleL().of([-1.0, -1.0, 1.0, 0.0]), JSArrayOfdoubleL().of([-1.0, -1.0, -1.0, 0.0])]);
    },
  ...
  dart.setMethodSignature(vector_math_64.Triangle, () => ({
    ...
    copyFrom: dart.fnType(dart.void, [dart.legacy(vector_math_64.Triangle)]),
    copyNormalInto: dart.fnType(dart.void, [dart.legacy(vector_math_64.Vector3)]),
    transform: dart.fnType(dart.void, [dart.legacy(vector_math_64.Matrix4)]),
    translate: dart.fnType(dart.void, [dart.legacy(vector_math_64.Vector3)])
  }));
  ...
  dart.setLibraryUri(vector_math_64.Triangle, L0);
  ...
  dart.setLibraryUri(vector_math_64.Vector, L0);
  vector_math_64.Vector2 = class Vector2 extends core.Object {
    ...
    static min(a, b, result) {
      ...
      t0 = result;
      (() => {
        t0.x = math.min(doubleL(), a.x, b.x);
        t0.y = math.min(doubleL(), a.y, b.y);
        return t0;
      })();
    }
    static max(a, b, result) {
      ...
      t0 = result;
      (() => {
        t0.x = math.max(doubleL(), a.x, b.x);
        t0.y = math.max(doubleL(), a.y, b.y);
        return t0;
      })();
    }
    ...
    _equals(other) {
      if (other == null) return false;
      return Vector2L().is(other) && this[_v2storage$][$_get](0) == other[_v2storage$][$_get](0) && this[_v2storage$][$_get](1) == other[_v2storage$][$_get](1);
    }
    get hashCode() {
  ...
  dart.setMethodSignature(vector_math_64.Vector2, () => ({
    ...
    setValues: dart.fnType(dart.void, [dart.legacy(core.double), dart.legacy(core.double)]),
    setZero: dart.fnType(dart.void, []),
    setFrom: dart.fnType(dart.void, [dart.legacy(vector_math_64.Vector2)]),
    splat: dart.fnType(dart.void, [dart.legacy(core.double)]),
    toString: dart.fnType(dart.legacy(core.String), []),
    [$toString]: dart.fnType(dart.legacy(core.String), []),
    _equals: dart.fnType(dart.legacy(core.bool), [dart.legacy(core.Object)]),
    [$_equals]: dart.fnType(dart.legacy(core.bool), [dart.legacy(core.Object)]),
    _negate: dart.fnType(dart.legacy(vector_math_64.Vector2), []),
    '-': dart.fnType(dart.legacy(vector_math_64.Vector2), [dart.legacy(vector_math_64.Vector2)]),
    '+': dart.fnType(dart.legacy(vector_math_64.Vector2), [dart.legacy(vector_math_64.Vector2)]),
    '/': dart.fnType(dart.legacy(vector_math_64.Vector2), [dart.legacy(core.double)]),
    '*': dart.fnType(dart.legacy(vector_math_64.Vector2), [dart.legacy(core.double)]),
    _get: dart.fnType(dart.legacy(core.double), [dart.legacy(core.int)]),
    _set: dart.fnType(dart.void, [dart.legacy(core.int), dart.legacy(core.double)]),
    normalize: dart.fnType(dart.legacy(core.double), []),
    normalizeLength: dart.fnType(dart.legacy(core.double), []),
    normalized: dart.fnType(dart.legacy(vector_math_64.Vector2), []),
    normalizeInto: dart.fnType(dart.legacy(vector_math_64.Vector2), [dart.legacy(vector_math_64.Vector2)]),
    distanceTo: dart.fnType(dart.legacy(core.double), [dart.legacy(vector_math_64.Vector2)]),
    distanceToSquared: dart.fnType(dart.legacy(core.double), [dart.legacy(vector_math_64.Vector2)]),
    angleTo: dart.fnType(dart.legacy(core.double), [dart.legacy(vector_math_64.Vector2)]),
    angleToSigned: dart.fnType(dart.legacy(core.double), [dart.legacy(vector_math_64.Vector2)]),
    dot: dart.fnType(dart.legacy(core.double), [dart.legacy(vector_math_64.Vector2)]),
    postmultiply: dart.fnType(dart.void, [dart.legacy(vector_math_64.Matrix2)]),
    cross: dart.fnType(dart.legacy(core.double), [dart.legacy(vector_math_64.Vector2)]),
    scaleOrthogonalInto: dart.fnType(dart.legacy(vector_math_64.Vector2), [dart.legacy(core.double), dart.legacy(vector_math_64.Vector2)]),
    reflect: dart.fnType(dart.void, [dart.legacy(vector_math_64.Vector2)]),
    reflected: dart.fnType(dart.legacy(vector_math_64.Vector2), [dart.legacy(vector_math_64.Vector2)]),
    relativeError: dart.fnType(dart.legacy(core.double), [dart.legacy(vector_math_64.Vector2)]),
    absoluteError: dart.fnType(dart.legacy(core.double), [dart.legacy(vector_math_64.Vector2)]),
    add: dart.fnType(dart.void, [dart.legacy(vector_math_64.Vector2)]),
    addScaled: dart.fnType(dart.void, [dart.legacy(vector_math_64.Vector2), dart.legacy(core.double)]),
    sub: dart.fnType(dart.void, [dart.legacy(vector_math_64.Vector2)]),
    multiply: dart.fnType(dart.void, [dart.legacy(vector_math_64.Vector2)]),
    divide: dart.fnType(dart.void, [dart.legacy(vector_math_64.Vector2)]),
    scale: dart.fnType(dart.void, [dart.legacy(core.double)]),
    scaled: dart.fnType(dart.legacy(vector_math_64.Vector2), [dart.legacy(core.double)]),
    negate: dart.fnType(dart.void, []),
    absolute: dart.fnType(dart.void, []),
    clamp: dart.fnType(dart.void, [dart.legacy(vector_math_64.Vector2), dart.legacy(vector_math_64.Vector2)]),
    clampScalar: dart.fnType(dart.void, [dart.legacy(core.double), dart.legacy(core.double)]),
    floor: dart.fnType(dart.void, []),
    ceil: dart.fnType(dart.void, []),
    round: dart.fnType(dart.void, []),
    roundToZero: dart.fnType(dart.void, []),
    clone: dart.fnType(dart.legacy(vector_math_64.Vector2), []),
    copyInto: dart.fnType(dart.legacy(vector_math_64.Vector2), [dart.legacy(vector_math_64.Vector2)]),
    copyIntoArray: dart.fnType(dart.void, [dart.legacy(core.List$(dart.legacy(core.double)))], [dart.legacy(core.int)]),
    copyFromArray: dart.fnType(dart.void, [dart.legacy(core.List$(dart.legacy(core.double)))], [dart.legacy(core.int)])
  }));
  dart.setGetterSignature(vector_math_64.Vector2, () => ({
    ...
    xx: dart.legacy(vector_math_64.Vector2),
    xy: dart.legacy(vector_math_64.Vector2),
    yx: dart.legacy(vector_math_64.Vector2),
    yy: dart.legacy(vector_math_64.Vector2),
    xxx: dart.legacy(vector_math_64.Vector3),
    xxy: dart.legacy(vector_math_64.Vector3),
    xyx: dart.legacy(vector_math_64.Vector3),
    xyy: dart.legacy(vector_math_64.Vector3),
    yxx: dart.legacy(vector_math_64.Vector3),
    yxy: dart.legacy(vector_math_64.Vector3),
    yyx: dart.legacy(vector_math_64.Vector3),
    yyy: dart.legacy(vector_math_64.Vector3),
    xxxx: dart.legacy(vector_math_64.Vector4),
    xxxy: dart.legacy(vector_math_64.Vector4),
    xxyx: dart.legacy(vector_math_64.Vector4),
    xxyy: dart.legacy(vector_math_64.Vector4),
    xyxx: dart.legacy(vector_math_64.Vector4),
    xyxy: dart.legacy(vector_math_64.Vector4),
    xyyx: dart.legacy(vector_math_64.Vector4),
    xyyy: dart.legacy(vector_math_64.Vector4),
    yxxx: dart.legacy(vector_math_64.Vector4),
    yxxy: dart.legacy(vector_math_64.Vector4),
    yxyx: dart.legacy(vector_math_64.Vector4),
    yxyy: dart.legacy(vector_math_64.Vector4),
    yyxx: dart.legacy(vector_math_64.Vector4),
    yyxy: dart.legacy(vector_math_64.Vector4),
    yyyx: dart.legacy(vector_math_64.Vector4),
    yyyy: dart.legacy(vector_math_64.Vector4),
    r: dart.legacy(core.double),
    g: dart.legacy(core.double),
    s: dart.legacy(core.double),
    t: dart.legacy(core.double),
    x: dart.legacy(core.double),
    y: dart.legacy(core.double),
    rr: dart.legacy(vector_math_64.Vector2),
    rg: dart.legacy(vector_math_64.Vector2),
    gr: dart.legacy(vector_math_64.Vector2),
    gg: dart.legacy(vector_math_64.Vector2),
    rrr: dart.legacy(vector_math_64.Vector3),
    rrg: dart.legacy(vector_math_64.Vector3),
    rgr: dart.legacy(vector_math_64.Vector3),
    rgg: dart.legacy(vector_math_64.Vector3),
    grr: dart.legacy(vector_math_64.Vector3),
    grg: dart.legacy(vector_math_64.Vector3),
    ggr: dart.legacy(vector_math_64.Vector3),
    ggg: dart.legacy(vector_math_64.Vector3),
    rrrr: dart.legacy(vector_math_64.Vector4),
    rrrg: dart.legacy(vector_math_64.Vector4),
    rrgr: dart.legacy(vector_math_64.Vector4),
    rrgg: dart.legacy(vector_math_64.Vector4),
    rgrr: dart.legacy(vector_math_64.Vector4),
    rgrg: dart.legacy(vector_math_64.Vector4),
    rggr: dart.legacy(vector_math_64.Vector4),
    rggg: dart.legacy(vector_math_64.Vector4),
    grrr: dart.legacy(vector_math_64.Vector4),
    grrg: dart.legacy(vector_math_64.Vector4),
    grgr: dart.legacy(vector_math_64.Vector4),
    grgg: dart.legacy(vector_math_64.Vector4),
    ggrr: dart.legacy(vector_math_64.Vector4),
    ggrg: dart.legacy(vector_math_64.Vector4),
    gggr: dart.legacy(vector_math_64.Vector4),
    gggg: dart.legacy(vector_math_64.Vector4),
    ss: dart.legacy(vector_math_64.Vector2),
    st: dart.legacy(vector_math_64.Vector2),
    ts: dart.legacy(vector_math_64.Vector2),
    tt: dart.legacy(vector_math_64.Vector2),
    sss: dart.legacy(vector_math_64.Vector3),
    sst: dart.legacy(vector_math_64.Vector3),
    sts: dart.legacy(vector_math_64.Vector3),
    stt: dart.legacy(vector_math_64.Vector3),
    tss: dart.legacy(vector_math_64.Vector3),
    tst: dart.legacy(vector_math_64.Vector3),
    tts: dart.legacy(vector_math_64.Vector3),
    ttt: dart.legacy(vector_math_64.Vector3),
    ssss: dart.legacy(vector_math_64.Vector4),
    ssst: dart.legacy(vector_math_64.Vector4),
    ssts: dart.legacy(vector_math_64.Vector4),
    sstt: dart.legacy(vector_math_64.Vector4),
    stss: dart.legacy(vector_math_64.Vector4),
    stst: dart.legacy(vector_math_64.Vector4),
    stts: dart.legacy(vector_math_64.Vector4),
    sttt: dart.legacy(vector_math_64.Vector4),
    tsss: dart.legacy(vector_math_64.Vector4),
    tsst: dart.legacy(vector_math_64.Vector4),
    tsts: dart.legacy(vector_math_64.Vector4),
    tstt: dart.legacy(vector_math_64.Vector4),
    ttss: dart.legacy(vector_math_64.Vector4),
    ttst: dart.legacy(vector_math_64.Vector4),
    ttts: dart.legacy(vector_math_64.Vector4),
    tttt: dart.legacy(vector_math_64.Vector4)
  }));
  ...
  dart.setLibraryUri(vector_math_64.Vector2, L0);
  dart.setFieldSignature(vector_math_64.Vector2, () => ({
    __proto__: dart.getFields(vector_math_64.Vector2.__proto__),
    [_v2storage$]: dart.finalFieldType(dart.legacy(typed_data.Float64List))
  }));
  ...
  vector_math_64.Vector3 = class Vector3 extends core.Object {
    ...
    _equals(other) {
      if (other == null) return false;
      return Vector3L().is(other) && this[_v3storage$][$_get](0) == other[_v3storage$][$_get](0) && this[_v3storage$][$_get](1) == other[_v3storage$][$_get](1) && this[_v3storage$][$_get](2) == other[_v3storage$][$_get](2);
    }
    get hashCode() {
  ...
  dart.setMethodSignature(vector_math_64.Vector3, () => ({
    ...
    setValues: dart.fnType(dart.void, [dart.legacy(core.double), dart.legacy(core.double), dart.legacy(core.double)]),
    setZero: dart.fnType(dart.void, []),
    setFrom: dart.fnType(dart.void, [dart.legacy(vector_math_64.Vector3)]),
    splat: dart.fnType(dart.void, [dart.legacy(core.double)]),
    toString: dart.fnType(dart.legacy(core.String), []),
    [$toString]: dart.fnType(dart.legacy(core.String), []),
    _equals: dart.fnType(dart.legacy(core.bool), [dart.legacy(core.Object)]),
    [$_equals]: dart.fnType(dart.legacy(core.bool), [dart.legacy(core.Object)]),
    _negate: dart.fnType(dart.legacy(vector_math_64.Vector3), []),
    '-': dart.fnType(dart.legacy(vector_math_64.Vector3), [dart.legacy(vector_math_64.Vector3)]),
    '+': dart.fnType(dart.legacy(vector_math_64.Vector3), [dart.legacy(vector_math_64.Vector3)]),
    '/': dart.fnType(dart.legacy(vector_math_64.Vector3), [dart.legacy(core.double)]),
    '*': dart.fnType(dart.legacy(vector_math_64.Vector3), [dart.legacy(core.double)]),
    _get: dart.fnType(dart.legacy(core.double), [dart.legacy(core.int)]),
    _set: dart.fnType(dart.void, [dart.legacy(core.int), dart.legacy(core.double)]),
    normalize: dart.fnType(dart.legacy(core.double), []),
    normalizeLength: dart.fnType(dart.legacy(core.double), []),
    normalized: dart.fnType(dart.legacy(vector_math_64.Vector3), []),
    normalizeInto: dart.fnType(dart.legacy(vector_math_64.Vector3), [dart.legacy(vector_math_64.Vector3)]),
    distanceTo: dart.fnType(dart.legacy(core.double), [dart.legacy(vector_math_64.Vector3)]),
    distanceToSquared: dart.fnType(dart.legacy(core.double), [dart.legacy(vector_math_64.Vector3)]),
    angleTo: dart.fnType(dart.legacy(core.double), [dart.legacy(vector_math_64.Vector3)]),
    angleToSigned: dart.fnType(dart.legacy(core.double), [dart.legacy(vector_math_64.Vector3), dart.legacy(vector_math_64.Vector3)]),
    dot: dart.fnType(dart.legacy(core.double), [dart.legacy(vector_math_64.Vector3)]),
    postmultiply: dart.fnType(dart.void, [dart.legacy(vector_math_64.Matrix3)]),
    cross: dart.fnType(dart.legacy(vector_math_64.Vector3), [dart.legacy(vector_math_64.Vector3)]),
    crossInto: dart.fnType(dart.legacy(vector_math_64.Vector3), [dart.legacy(vector_math_64.Vector3), dart.legacy(vector_math_64.Vector3)]),
    reflect: dart.fnType(dart.void, [dart.legacy(vector_math_64.Vector3)]),
    reflected: dart.fnType(dart.legacy(vector_math_64.Vector3), [dart.legacy(vector_math_64.Vector3)]),
    applyProjection: dart.fnType(dart.void, [dart.legacy(vector_math_64.Matrix4)]),
    applyAxisAngle: dart.fnType(dart.void, [dart.legacy(vector_math_64.Vector3), dart.legacy(core.double)]),
    applyQuaternion: dart.fnType(dart.void, [dart.legacy(vector_math_64.Quaternion)]),
    applyMatrix3: dart.fnType(dart.void, [dart.legacy(vector_math_64.Matrix3)]),
    applyMatrix4: dart.fnType(dart.void, [dart.legacy(vector_math_64.Matrix4)]),
    relativeError: dart.fnType(dart.legacy(core.double), [dart.legacy(vector_math_64.Vector3)]),
    absoluteError: dart.fnType(dart.legacy(core.double), [dart.legacy(vector_math_64.Vector3)]),
    add: dart.fnType(dart.void, [dart.legacy(vector_math_64.Vector3)]),
    addScaled: dart.fnType(dart.void, [dart.legacy(vector_math_64.Vector3), dart.legacy(core.double)]),
    sub: dart.fnType(dart.void, [dart.legacy(vector_math_64.Vector3)]),
    multiply: dart.fnType(dart.void, [dart.legacy(vector_math_64.Vector3)]),
    divide: dart.fnType(dart.void, [dart.legacy(vector_math_64.Vector3)]),
    scale: dart.fnType(dart.void, [dart.legacy(core.double)]),
    scaled: dart.fnType(dart.legacy(vector_math_64.Vector3), [dart.legacy(core.double)]),
    negate: dart.fnType(dart.void, []),
    absolute: dart.fnType(dart.void, []),
    clamp: dart.fnType(dart.void, [dart.legacy(vector_math_64.Vector3), dart.legacy(vector_math_64.Vector3)]),
    clampScalar: dart.fnType(dart.void, [dart.legacy(core.double), dart.legacy(core.double)]),
    floor: dart.fnType(dart.void, []),
    ceil: dart.fnType(dart.void, []),
    round: dart.fnType(dart.void, []),
    roundToZero: dart.fnType(dart.void, []),
    clone: dart.fnType(dart.legacy(vector_math_64.Vector3), []),
    copyInto: dart.fnType(dart.legacy(vector_math_64.Vector3), [dart.legacy(vector_math_64.Vector3)]),
    copyIntoArray: dart.fnType(dart.void, [dart.legacy(core.List$(dart.legacy(core.double)))], [dart.legacy(core.int)]),
    copyFromArray: dart.fnType(dart.void, [dart.legacy(core.List$(dart.legacy(core.double)))], [dart.legacy(core.int)])
  }));
  dart.setGetterSignature(vector_math_64.Vector3, () => ({
    ...
    xx: dart.legacy(vector_math_64.Vector2),
    xy: dart.legacy(vector_math_64.Vector2),
    xz: dart.legacy(vector_math_64.Vector2),
    yx: dart.legacy(vector_math_64.Vector2),
    yy: dart.legacy(vector_math_64.Vector2),
    yz: dart.legacy(vector_math_64.Vector2),
    zx: dart.legacy(vector_math_64.Vector2),
    zy: dart.legacy(vector_math_64.Vector2),
    zz: dart.legacy(vector_math_64.Vector2),
    xxx: dart.legacy(vector_math_64.Vector3),
    xxy: dart.legacy(vector_math_64.Vector3),
    xxz: dart.legacy(vector_math_64.Vector3),
    xyx: dart.legacy(vector_math_64.Vector3),
    xyy: dart.legacy(vector_math_64.Vector3),
    xyz: dart.legacy(vector_math_64.Vector3),
    xzx: dart.legacy(vector_math_64.Vector3),
    xzy: dart.legacy(vector_math_64.Vector3),
    xzz: dart.legacy(vector_math_64.Vector3),
    yxx: dart.legacy(vector_math_64.Vector3),
    yxy: dart.legacy(vector_math_64.Vector3),
    yxz: dart.legacy(vector_math_64.Vector3),
    yyx: dart.legacy(vector_math_64.Vector3),
    yyy: dart.legacy(vector_math_64.Vector3),
    yyz: dart.legacy(vector_math_64.Vector3),
    yzx: dart.legacy(vector_math_64.Vector3),
    yzy: dart.legacy(vector_math_64.Vector3),
    yzz: dart.legacy(vector_math_64.Vector3),
    zxx: dart.legacy(vector_math_64.Vector3),
    zxy: dart.legacy(vector_math_64.Vector3),
    zxz: dart.legacy(vector_math_64.Vector3),
    zyx: dart.legacy(vector_math_64.Vector3),
    zyy: dart.legacy(vector_math_64.Vector3),
    zyz: dart.legacy(vector_math_64.Vector3),
    zzx: dart.legacy(vector_math_64.Vector3),
    zzy: dart.legacy(vector_math_64.Vector3),
    zzz: dart.legacy(vector_math_64.Vector3),
    xxxx: dart.legacy(vector_math_64.Vector4),
    xxxy: dart.legacy(vector_math_64.Vector4),
    xxxz: dart.legacy(vector_math_64.Vector4),
    xxyx: dart.legacy(vector_math_64.Vector4),
    xxyy: dart.legacy(vector_math_64.Vector4),
    xxyz: dart.legacy(vector_math_64.Vector4),
    xxzx: dart.legacy(vector_math_64.Vector4),
    xxzy: dart.legacy(vector_math_64.Vector4),
    xxzz: dart.legacy(vector_math_64.Vector4),
    xyxx: dart.legacy(vector_math_64.Vector4),
    xyxy: dart.legacy(vector_math_64.Vector4),
    xyxz: dart.legacy(vector_math_64.Vector4),
    xyyx: dart.legacy(vector_math_64.Vector4),
    xyyy: dart.legacy(vector_math_64.Vector4),
    xyyz: dart.legacy(vector_math_64.Vector4),
    xyzx: dart.legacy(vector_math_64.Vector4),
    xyzy: dart.legacy(vector_math_64.Vector4),
    xyzz: dart.legacy(vector_math_64.Vector4),
    xzxx: dart.legacy(vector_math_64.Vector4),
    xzxy: dart.legacy(vector_math_64.Vector4),
    xzxz: dart.legacy(vector_math_64.Vector4),
    xzyx: dart.legacy(vector_math_64.Vector4),
    xzyy: dart.legacy(vector_math_64.Vector4),
    xzyz: dart.legacy(vector_math_64.Vector4),
    xzzx: dart.legacy(vector_math_64.Vector4),
    xzzy: dart.legacy(vector_math_64.Vector4),
    xzzz: dart.legacy(vector_math_64.Vector4),
    yxxx: dart.legacy(vector_math_64.Vector4),
    yxxy: dart.legacy(vector_math_64.Vector4),
    yxxz: dart.legacy(vector_math_64.Vector4),
    yxyx: dart.legacy(vector_math_64.Vector4),
    yxyy: dart.legacy(vector_math_64.Vector4),
    yxyz: dart.legacy(vector_math_64.Vector4),
    yxzx: dart.legacy(vector_math_64.Vector4),
    yxzy: dart.legacy(vector_math_64.Vector4),
    yxzz: dart.legacy(vector_math_64.Vector4),
    yyxx: dart.legacy(vector_math_64.Vector4),
    yyxy: dart.legacy(vector_math_64.Vector4),
    yyxz: dart.legacy(vector_math_64.Vector4),
    yyyx: dart.legacy(vector_math_64.Vector4),
    yyyy: dart.legacy(vector_math_64.Vector4),
    yyyz: dart.legacy(vector_math_64.Vector4),
    yyzx: dart.legacy(vector_math_64.Vector4),
    yyzy: dart.legacy(vector_math_64.Vector4),
    yyzz: dart.legacy(vector_math_64.Vector4),
    yzxx: dart.legacy(vector_math_64.Vector4),
    yzxy: dart.legacy(vector_math_64.Vector4),
    yzxz: dart.legacy(vector_math_64.Vector4),
    yzyx: dart.legacy(vector_math_64.Vector4),
    yzyy: dart.legacy(vector_math_64.Vector4),
    yzyz: dart.legacy(vector_math_64.Vector4),
    yzzx: dart.legacy(vector_math_64.Vector4),
    yzzy: dart.legacy(vector_math_64.Vector4),
    yzzz: dart.legacy(vector_math_64.Vector4),
    zxxx: dart.legacy(vector_math_64.Vector4),
    zxxy: dart.legacy(vector_math_64.Vector4),
    zxxz: dart.legacy(vector_math_64.Vector4),
    zxyx: dart.legacy(vector_math_64.Vector4),
    zxyy: dart.legacy(vector_math_64.Vector4),
    zxyz: dart.legacy(vector_math_64.Vector4),
    zxzx: dart.legacy(vector_math_64.Vector4),
    zxzy: dart.legacy(vector_math_64.Vector4),
    zxzz: dart.legacy(vector_math_64.Vector4),
    zyxx: dart.legacy(vector_math_64.Vector4),
    zyxy: dart.legacy(vector_math_64.Vector4),
    zyxz: dart.legacy(vector_math_64.Vector4),
    zyyx: dart.legacy(vector_math_64.Vector4),
    zyyy: dart.legacy(vector_math_64.Vector4),
    zyyz: dart.legacy(vector_math_64.Vector4),
    zyzx: dart.legacy(vector_math_64.Vector4),
    zyzy: dart.legacy(vector_math_64.Vector4),
    zyzz: dart.legacy(vector_math_64.Vector4),
    zzxx: dart.legacy(vector_math_64.Vector4),
    zzxy: dart.legacy(vector_math_64.Vector4),
    zzxz: dart.legacy(vector_math_64.Vector4),
    zzyx: dart.legacy(vector_math_64.Vector4),
    zzyy: dart.legacy(vector_math_64.Vector4),
    zzyz: dart.legacy(vector_math_64.Vector4),
    zzzx: dart.legacy(vector_math_64.Vector4),
    zzzy: dart.legacy(vector_math_64.Vector4),
    zzzz: dart.legacy(vector_math_64.Vector4),
    r: dart.legacy(core.double),
    g: dart.legacy(core.double),
    b: dart.legacy(core.double),
    s: dart.legacy(core.double),
    t: dart.legacy(core.double),
    p: dart.legacy(core.double),
    x: dart.legacy(core.double),
    y: dart.legacy(core.double),
    z: dart.legacy(core.double),
    rr: dart.legacy(vector_math_64.Vector2),
    rg: dart.legacy(vector_math_64.Vector2),
    rb: dart.legacy(vector_math_64.Vector2),
    gr: dart.legacy(vector_math_64.Vector2),
    gg: dart.legacy(vector_math_64.Vector2),
    gb: dart.legacy(vector_math_64.Vector2),
    br: dart.legacy(vector_math_64.Vector2),
    bg: dart.legacy(vector_math_64.Vector2),
    bb: dart.legacy(vector_math_64.Vector2),
    rrr: dart.legacy(vector_math_64.Vector3),
    rrg: dart.legacy(vector_math_64.Vector3),
    rrb: dart.legacy(vector_math_64.Vector3),
    rgr: dart.legacy(vector_math_64.Vector3),
    rgg: dart.legacy(vector_math_64.Vector3),
    rgb: dart.legacy(vector_math_64.Vector3),
    rbr: dart.legacy(vector_math_64.Vector3),
    rbg: dart.legacy(vector_math_64.Vector3),
    rbb: dart.legacy(vector_math_64.Vector3),
    grr: dart.legacy(vector_math_64.Vector3),
    grg: dart.legacy(vector_math_64.Vector3),
    grb: dart.legacy(vector_math_64.Vector3),
    ggr: dart.legacy(vector_math_64.Vector3),
    ggg: dart.legacy(vector_math_64.Vector3),
    ggb: dart.legacy(vector_math_64.Vector3),
    gbr: dart.legacy(vector_math_64.Vector3),
    gbg: dart.legacy(vector_math_64.Vector3),
    gbb: dart.legacy(vector_math_64.Vector3),
    brr: dart.legacy(vector_math_64.Vector3),
    brg: dart.legacy(vector_math_64.Vector3),
    brb: dart.legacy(vector_math_64.Vector3),
    bgr: dart.legacy(vector_math_64.Vector3),
    bgg: dart.legacy(vector_math_64.Vector3),
    bgb: dart.legacy(vector_math_64.Vector3),
    bbr: dart.legacy(vector_math_64.Vector3),
    bbg: dart.legacy(vector_math_64.Vector3),
    bbb: dart.legacy(vector_math_64.Vector3),
    rrrr: dart.legacy(vector_math_64.Vector4),
    rrrg: dart.legacy(vector_math_64.Vector4),
    rrrb: dart.legacy(vector_math_64.Vector4),
    rrgr: dart.legacy(vector_math_64.Vector4),
    rrgg: dart.legacy(vector_math_64.Vector4),
    rrgb: dart.legacy(vector_math_64.Vector4),
    rrbr: dart.legacy(vector_math_64.Vector4),
    rrbg: dart.legacy(vector_math_64.Vector4),
    rrbb: dart.legacy(vector_math_64.Vector4),
    rgrr: dart.legacy(vector_math_64.Vector4),
    rgrg: dart.legacy(vector_math_64.Vector4),
    rgrb: dart.legacy(vector_math_64.Vector4),
    rggr: dart.legacy(vector_math_64.Vector4),
    rggg: dart.legacy(vector_math_64.Vector4),
    rggb: dart.legacy(vector_math_64.Vector4),
    rgbr: dart.legacy(vector_math_64.Vector4),
    rgbg: dart.legacy(vector_math_64.Vector4),
    rgbb: dart.legacy(vector_math_64.Vector4),
    rbrr: dart.legacy(vector_math_64.Vector4),
    rbrg: dart.legacy(vector_math_64.Vector4),
    rbrb: dart.legacy(vector_math_64.Vector4),
    rbgr: dart.legacy(vector_math_64.Vector4),
    rbgg: dart.legacy(vector_math_64.Vector4),
    rbgb: dart.legacy(vector_math_64.Vector4),
    rbbr: dart.legacy(vector_math_64.Vector4),
    rbbg: dart.legacy(vector_math_64.Vector4),
    rbbb: dart.legacy(vector_math_64.Vector4),
    grrr: dart.legacy(vector_math_64.Vector4),
    grrg: dart.legacy(vector_math_64.Vector4),
    grrb: dart.legacy(vector_math_64.Vector4),
    grgr: dart.legacy(vector_math_64.Vector4),
    grgg: dart.legacy(vector_math_64.Vector4),
    grgb: dart.legacy(vector_math_64.Vector4),
    grbr: dart.legacy(vector_math_64.Vector4),
    grbg: dart.legacy(vector_math_64.Vector4),
    grbb: dart.legacy(vector_math_64.Vector4),
    ggrr: dart.legacy(vector_math_64.Vector4),
    ggrg: dart.legacy(vector_math_64.Vector4),
    ggrb: dart.legacy(vector_math_64.Vector4),
    gggr: dart.legacy(vector_math_64.Vector4),
    gggg: dart.legacy(vector_math_64.Vector4),
    gggb: dart.legacy(vector_math_64.Vector4),
    ggbr: dart.legacy(vector_math_64.Vector4),
    ggbg: dart.legacy(vector_math_64.Vector4),
    ggbb: dart.legacy(vector_math_64.Vector4),
    gbrr: dart.legacy(vector_math_64.Vector4),
    gbrg: dart.legacy(vector_math_64.Vector4),
    gbrb: dart.legacy(vector_math_64.Vector4),
    gbgr: dart.legacy(vector_math_64.Vector4),
    gbgg: dart.legacy(vector_math_64.Vector4),
    gbgb: dart.legacy(vector_math_64.Vector4),
    gbbr: dart.legacy(vector_math_64.Vector4),
    gbbg: dart.legacy(vector_math_64.Vector4),
    gbbb: dart.legacy(vector_math_64.Vector4),
    brrr: dart.legacy(vector_math_64.Vector4),
    brrg: dart.legacy(vector_math_64.Vector4),
    brrb: dart.legacy(vector_math_64.Vector4),
    brgr: dart.legacy(vector_math_64.Vector4),
    brgg: dart.legacy(vector_math_64.Vector4),
    brgb: dart.legacy(vector_math_64.Vector4),
    brbr: dart.legacy(vector_math_64.Vector4),
    brbg: dart.legacy(vector_math_64.Vector4),
    brbb: dart.legacy(vector_math_64.Vector4),
    bgrr: dart.legacy(vector_math_64.Vector4),
    bgrg: dart.legacy(vector_math_64.Vector4),
    bgrb: dart.legacy(vector_math_64.Vector4),
    bggr: dart.legacy(vector_math_64.Vector4),
    bggg: dart.legacy(vector_math_64.Vector4),
    bggb: dart.legacy(vector_math_64.Vector4),
    bgbr: dart.legacy(vector_math_64.Vector4),
    bgbg: dart.legacy(vector_math_64.Vector4),
    bgbb: dart.legacy(vector_math_64.Vector4),
    bbrr: dart.legacy(vector_math_64.Vector4),
    bbrg: dart.legacy(vector_math_64.Vector4),
    bbrb: dart.legacy(vector_math_64.Vector4),
    bbgr: dart.legacy(vector_math_64.Vector4),
    bbgg: dart.legacy(vector_math_64.Vector4),
    bbgb: dart.legacy(vector_math_64.Vector4),
    bbbr: dart.legacy(vector_math_64.Vector4),
    bbbg: dart.legacy(vector_math_64.Vector4),
    bbbb: dart.legacy(vector_math_64.Vector4),
    ss: dart.legacy(vector_math_64.Vector2),
    st: dart.legacy(vector_math_64.Vector2),
    sp: dart.legacy(vector_math_64.Vector2),
    ts: dart.legacy(vector_math_64.Vector2),
    tt: dart.legacy(vector_math_64.Vector2),
    tp: dart.legacy(vector_math_64.Vector2),
    ps: dart.legacy(vector_math_64.Vector2),
    pt: dart.legacy(vector_math_64.Vector2),
    pp: dart.legacy(vector_math_64.Vector2),
    sss: dart.legacy(vector_math_64.Vector3),
    sst: dart.legacy(vector_math_64.Vector3),
    ssp: dart.legacy(vector_math_64.Vector3),
    sts: dart.legacy(vector_math_64.Vector3),
    stt: dart.legacy(vector_math_64.Vector3),
    stp: dart.legacy(vector_math_64.Vector3),
    sps: dart.legacy(vector_math_64.Vector3),
    spt: dart.legacy(vector_math_64.Vector3),
    spp: dart.legacy(vector_math_64.Vector3),
    tss: dart.legacy(vector_math_64.Vector3),
    tst: dart.legacy(vector_math_64.Vector3),
    tsp: dart.legacy(vector_math_64.Vector3),
    tts: dart.legacy(vector_math_64.Vector3),
    ttt: dart.legacy(vector_math_64.Vector3),
    ttp: dart.legacy(vector_math_64.Vector3),
    tps: dart.legacy(vector_math_64.Vector3),
    tpt: dart.legacy(vector_math_64.Vector3),
    tpp: dart.legacy(vector_math_64.Vector3),
    pss: dart.legacy(vector_math_64.Vector3),
    pst: dart.legacy(vector_math_64.Vector3),
    psp: dart.legacy(vector_math_64.Vector3),
    pts: dart.legacy(vector_math_64.Vector3),
    ptt: dart.legacy(vector_math_64.Vector3),
    ptp: dart.legacy(vector_math_64.Vector3),
    pps: dart.legacy(vector_math_64.Vector3),
    ppt: dart.legacy(vector_math_64.Vector3),
    ppp: dart.legacy(vector_math_64.Vector3),
    ssss: dart.legacy(vector_math_64.Vector4),
    ssst: dart.legacy(vector_math_64.Vector4),
    sssp: dart.legacy(vector_math_64.Vector4),
    ssts: dart.legacy(vector_math_64.Vector4),
    sstt: dart.legacy(vector_math_64.Vector4),
    sstp: dart.legacy(vector_math_64.Vector4),
    ssps: dart.legacy(vector_math_64.Vector4),
    sspt: dart.legacy(vector_math_64.Vector4),
    sspp: dart.legacy(vector_math_64.Vector4),
    stss: dart.legacy(vector_math_64.Vector4),
    stst: dart.legacy(vector_math_64.Vector4),
    stsp: dart.legacy(vector_math_64.Vector4),
    stts: dart.legacy(vector_math_64.Vector4),
    sttt: dart.legacy(vector_math_64.Vector4),
    sttp: dart.legacy(vector_math_64.Vector4),
    stps: dart.legacy(vector_math_64.Vector4),
    stpt: dart.legacy(vector_math_64.Vector4),
    stpp: dart.legacy(vector_math_64.Vector4),
    spss: dart.legacy(vector_math_64.Vector4),
    spst: dart.legacy(vector_math_64.Vector4),
    spsp: dart.legacy(vector_math_64.Vector4),
    spts: dart.legacy(vector_math_64.Vector4),
    sptt: dart.legacy(vector_math_64.Vector4),
    sptp: dart.legacy(vector_math_64.Vector4),
    spps: dart.legacy(vector_math_64.Vector4),
    sppt: dart.legacy(vector_math_64.Vector4),
    sppp: dart.legacy(vector_math_64.Vector4),
    tsss: dart.legacy(vector_math_64.Vector4),
    tsst: dart.legacy(vector_math_64.Vector4),
    tssp: dart.legacy(vector_math_64.Vector4),
    tsts: dart.legacy(vector_math_64.Vector4),
    tstt: dart.legacy(vector_math_64.Vector4),
    tstp: dart.legacy(vector_math_64.Vector4),
    tsps: dart.legacy(vector_math_64.Vector4),
    tspt: dart.legacy(vector_math_64.Vector4),
    tspp: dart.legacy(vector_math_64.Vector4),
    ttss: dart.legacy(vector_math_64.Vector4),
    ttst: dart.legacy(vector_math_64.Vector4),
    ttsp: dart.legacy(vector_math_64.Vector4),
    ttts: dart.legacy(vector_math_64.Vector4),
    tttt: dart.legacy(vector_math_64.Vector4),
    tttp: dart.legacy(vector_math_64.Vector4),
    ttps: dart.legacy(vector_math_64.Vector4),
    ttpt: dart.legacy(vector_math_64.Vector4),
    ttpp: dart.legacy(vector_math_64.Vector4),
    tpss: dart.legacy(vector_math_64.Vector4),
    tpst: dart.legacy(vector_math_64.Vector4),
    tpsp: dart.legacy(vector_math_64.Vector4),
    tpts: dart.legacy(vector_math_64.Vector4),
    tptt: dart.legacy(vector_math_64.Vector4),
    tptp: dart.legacy(vector_math_64.Vector4),
    tpps: dart.legacy(vector_math_64.Vector4),
    tppt: dart.legacy(vector_math_64.Vector4),
    tppp: dart.legacy(vector_math_64.Vector4),
    psss: dart.legacy(vector_math_64.Vector4),
    psst: dart.legacy(vector_math_64.Vector4),
    pssp: dart.legacy(vector_math_64.Vector4),
    psts: dart.legacy(vector_math_64.Vector4),
    pstt: dart.legacy(vector_math_64.Vector4),
    pstp: dart.legacy(vector_math_64.Vector4),
    psps: dart.legacy(vector_math_64.Vector4),
    pspt: dart.legacy(vector_math_64.Vector4),
    pspp: dart.legacy(vector_math_64.Vector4),
    ptss: dart.legacy(vector_math_64.Vector4),
    ptst: dart.legacy(vector_math_64.Vector4),
    ptsp: dart.legacy(vector_math_64.Vector4),
    ptts: dart.legacy(vector_math_64.Vector4),
    pttt: dart.legacy(vector_math_64.Vector4),
    pttp: dart.legacy(vector_math_64.Vector4),
    ptps: dart.legacy(vector_math_64.Vector4),
    ptpt: dart.legacy(vector_math_64.Vector4),
    ptpp: dart.legacy(vector_math_64.Vector4),
    ppss: dart.legacy(vector_math_64.Vector4),
    ppst: dart.legacy(vector_math_64.Vector4),
    ppsp: dart.legacy(vector_math_64.Vector4),
    ppts: dart.legacy(vector_math_64.Vector4),
    pptt: dart.legacy(vector_math_64.Vector4),
    pptp: dart.legacy(vector_math_64.Vector4),
    ppps: dart.legacy(vector_math_64.Vector4),
    pppt: dart.legacy(vector_math_64.Vector4),
    pppp: dart.legacy(vector_math_64.Vector4)
  }));
  ...
  dart.setLibraryUri(vector_math_64.Vector3, L0);
  dart.setFieldSignature(vector_math_64.Vector3, () => ({
    __proto__: dart.getFields(vector_math_64.Vector3.__proto__),
    [_v3storage$]: dart.finalFieldType(dart.legacy(typed_data.Float64List))
  }));
  ...
  vector_math_64.Vector4 = class Vector4 extends core.Object {
    ...
    _equals(other) {
      if (other == null) return false;
      return Vector4L().is(other) && this[_v4storage$][$_get](0) == other[_v4storage$][$_get](0) && this[_v4storage$][$_get](1) == other[_v4storage$][$_get](1) && this[_v4storage$][$_get](2) == other[_v4storage$][$_get](2) && this[_v4storage$][$_get](3) == other[_v4storage$][$_get](3);
    }
    get hashCode() {
  ...
  dart.setMethodSignature(vector_math_64.Vector4, () => ({
    ...
    setZero: dart.fnType(dart.void, []),
    setIdentity: dart.fnType(dart.void, []),
    setFrom: dart.fnType(dart.void, [dart.legacy(vector_math_64.Vector4)]),
    splat: dart.fnType(dart.void, [dart.legacy(core.double)]),
    toString: dart.fnType(dart.legacy(core.String), []),
    [$toString]: dart.fnType(dart.legacy(core.String), []),
    _equals: dart.fnType(dart.legacy(core.bool), [dart.legacy(core.Object)]),
    [$_equals]: dart.fnType(dart.legacy(core.bool), [dart.legacy(core.Object)]),
    _negate: dart.fnType(dart.legacy(vector_math_64.Vector4), []),
    '-': dart.fnType(dart.legacy(vector_math_64.Vector4), [dart.legacy(vector_math_64.Vector4)]),
    '+': dart.fnType(dart.legacy(vector_math_64.Vector4), [dart.legacy(vector_math_64.Vector4)]),
    '/': dart.fnType(dart.legacy(vector_math_64.Vector4), [dart.legacy(core.double)]),
    '*': dart.fnType(dart.legacy(vector_math_64.Vector4), [dart.legacy(core.double)]),
    _get: dart.fnType(dart.legacy(core.double), [dart.legacy(core.int)]),
    _set: dart.fnType(dart.void, [dart.legacy(core.int), dart.legacy(core.double)]),
    normalize: dart.fnType(dart.legacy(core.double), []),
    normalizeLength: dart.fnType(dart.legacy(core.double), []),
    normalized: dart.fnType(dart.legacy(vector_math_64.Vector4), []),
    normalizeInto: dart.fnType(dart.legacy(vector_math_64.Vector4), [dart.legacy(vector_math_64.Vector4)]),
    distanceTo: dart.fnType(dart.legacy(core.double), [dart.legacy(vector_math_64.Vector4)]),
    distanceToSquared: dart.fnType(dart.legacy(core.double), [dart.legacy(vector_math_64.Vector4)]),
    dot: dart.fnType(dart.legacy(core.double), [dart.legacy(vector_math_64.Vector4)]),
    applyMatrix4: dart.fnType(dart.void, [dart.legacy(vector_math_64.Matrix4)]),
    relativeError: dart.fnType(dart.legacy(core.double), [dart.legacy(vector_math_64.Vector4)]),
    absoluteError: dart.fnType(dart.legacy(core.double), [dart.legacy(vector_math_64.Vector4)]),
    add: dart.fnType(dart.void, [dart.legacy(vector_math_64.Vector4)]),
    addScaled: dart.fnType(dart.void, [dart.legacy(vector_math_64.Vector4), dart.legacy(core.double)]),
    sub: dart.fnType(dart.void, [dart.legacy(vector_math_64.Vector4)]),
    multiply: dart.fnType(dart.void, [dart.legacy(vector_math_64.Vector4)]),
    div: dart.fnType(dart.void, [dart.legacy(vector_math_64.Vector4)]),
    scale: dart.fnType(dart.void, [dart.legacy(core.double)]),
    scaled: dart.fnType(dart.legacy(vector_math_64.Vector4), [dart.legacy(core.double)]),
    negate: dart.fnType(dart.void, []),
    absolute: dart.fnType(dart.void, []),
    clamp: dart.fnType(dart.void, [dart.legacy(vector_math_64.Vector4), dart.legacy(vector_math_64.Vector4)]),
    clampScalar: dart.fnType(dart.void, [dart.legacy(core.double), dart.legacy(core.double)]),
    floor: dart.fnType(dart.void, []),
    ceil: dart.fnType(dart.void, []),
    round: dart.fnType(dart.void, []),
    roundToZero: dart.fnType(dart.void, []),
    clone: dart.fnType(dart.legacy(vector_math_64.Vector4), []),
    copyInto: dart.fnType(dart.legacy(vector_math_64.Vector4), [dart.legacy(vector_math_64.Vector4)]),
    copyIntoArray: dart.fnType(dart.void, [dart.legacy(core.List$(dart.legacy(core.double)))], [dart.legacy(core.int)]),
    copyFromArray: dart.fnType(dart.void, [dart.legacy(core.List$(dart.legacy(core.double)))], [dart.legacy(core.int)])
  }));
  dart.setGetterSignature(vector_math_64.Vector4, () => ({
    ...
    xy: dart.legacy(vector_math_64.Vector2),
    xz: dart.legacy(vector_math_64.Vector2),
    xw: dart.legacy(vector_math_64.Vector2),
    yx: dart.legacy(vector_math_64.Vector2),
    yy: dart.legacy(vector_math_64.Vector2),
    yz: dart.legacy(vector_math_64.Vector2),
    yw: dart.legacy(vector_math_64.Vector2),
    zx: dart.legacy(vector_math_64.Vector2),
    zy: dart.legacy(vector_math_64.Vector2),
    zz: dart.legacy(vector_math_64.Vector2),
    zw: dart.legacy(vector_math_64.Vector2),
    wx: dart.legacy(vector_math_64.Vector2),
    wy: dart.legacy(vector_math_64.Vector2),
    wz: dart.legacy(vector_math_64.Vector2),
    ww: dart.legacy(vector_math_64.Vector2),
    xxx: dart.legacy(vector_math_64.Vector3),
    xxy: dart.legacy(vector_math_64.Vector3),
    xxz: dart.legacy(vector_math_64.Vector3),
    xxw: dart.legacy(vector_math_64.Vector3),
    xyx: dart.legacy(vector_math_64.Vector3),
    xyy: dart.legacy(vector_math_64.Vector3),
    xyz: dart.legacy(vector_math_64.Vector3),
    xyw: dart.legacy(vector_math_64.Vector3),
    xzx: dart.legacy(vector_math_64.Vector3),
    xzy: dart.legacy(vector_math_64.Vector3),
    xzz: dart.legacy(vector_math_64.Vector3),
    xzw: dart.legacy(vector_math_64.Vector3),
    xwx: dart.legacy(vector_math_64.Vector3),
    xwy: dart.legacy(vector_math_64.Vector3),
    xwz: dart.legacy(vector_math_64.Vector3),
    xww: dart.legacy(vector_math_64.Vector3),
    yxx: dart.legacy(vector_math_64.Vector3),
    yxy: dart.legacy(vector_math_64.Vector3),
    yxz: dart.legacy(vector_math_64.Vector3),
    yxw: dart.legacy(vector_math_64.Vector3),
    yyx: dart.legacy(vector_math_64.Vector3),
    yyy: dart.legacy(vector_math_64.Vector3),
    yyz: dart.legacy(vector_math_64.Vector3),
    yyw: dart.legacy(vector_math_64.Vector3),
    yzx: dart.legacy(vector_math_64.Vector3),
    yzy: dart.legacy(vector_math_64.Vector3),
    yzz: dart.legacy(vector_math_64.Vector3),
    yzw: dart.legacy(vector_math_64.Vector3),
    ywx: dart.legacy(vector_math_64.Vector3),
    ywy: dart.legacy(vector_math_64.Vector3),
    ywz: dart.legacy(vector_math_64.Vector3),
    yww: dart.legacy(vector_math_64.Vector3),
    zxx: dart.legacy(vector_math_64.Vector3),
    zxy: dart.legacy(vector_math_64.Vector3),
    zxz: dart.legacy(vector_math_64.Vector3),
    zxw: dart.legacy(vector_math_64.Vector3),
    zyx: dart.legacy(vector_math_64.Vector3),
    zyy: dart.legacy(vector_math_64.Vector3),
    zyz: dart.legacy(vector_math_64.Vector3),
    zyw: dart.legacy(vector_math_64.Vector3),
    zzx: dart.legacy(vector_math_64.Vector3),
    zzy: dart.legacy(vector_math_64.Vector3),
    zzz: dart.legacy(vector_math_64.Vector3),
    zzw: dart.legacy(vector_math_64.Vector3),
    zwx: dart.legacy(vector_math_64.Vector3),
    zwy: dart.legacy(vector_math_64.Vector3),
    zwz: dart.legacy(vector_math_64.Vector3),
    zww: dart.legacy(vector_math_64.Vector3),
    wxx: dart.legacy(vector_math_64.Vector3),
    wxy: dart.legacy(vector_math_64.Vector3),
    wxz: dart.legacy(vector_math_64.Vector3),
    wxw: dart.legacy(vector_math_64.Vector3),
    wyx: dart.legacy(vector_math_64.Vector3),
    wyy: dart.legacy(vector_math_64.Vector3),
    wyz: dart.legacy(vector_math_64.Vector3),
    wyw: dart.legacy(vector_math_64.Vector3),
    wzx: dart.legacy(vector_math_64.Vector3),
    wzy: dart.legacy(vector_math_64.Vector3),
    wzz: dart.legacy(vector_math_64.Vector3),
    wzw: dart.legacy(vector_math_64.Vector3),
    wwx: dart.legacy(vector_math_64.Vector3),
    wwy: dart.legacy(vector_math_64.Vector3),
    wwz: dart.legacy(vector_math_64.Vector3),
    www: dart.legacy(vector_math_64.Vector3),
    xxxx: dart.legacy(vector_math_64.Vector4),
    xxxy: dart.legacy(vector_math_64.Vector4),
    xxxz: dart.legacy(vector_math_64.Vector4),
    xxxw: dart.legacy(vector_math_64.Vector4),
    xxyx: dart.legacy(vector_math_64.Vector4),
    xxyy: dart.legacy(vector_math_64.Vector4),
    xxyz: dart.legacy(vector_math_64.Vector4),
    xxyw: dart.legacy(vector_math_64.Vector4),
    xxzx: dart.legacy(vector_math_64.Vector4),
    xxzy: dart.legacy(vector_math_64.Vector4),
    xxzz: dart.legacy(vector_math_64.Vector4),
    xxzw: dart.legacy(vector_math_64.Vector4),
    xxwx: dart.legacy(vector_math_64.Vector4),
    xxwy: dart.legacy(vector_math_64.Vector4),
    xxwz: dart.legacy(vector_math_64.Vector4),
    xxww: dart.legacy(vector_math_64.Vector4),
    xyxx: dart.legacy(vector_math_64.Vector4),
    xyxy: dart.legacy(vector_math_64.Vector4),
    xyxz: dart.legacy(vector_math_64.Vector4),
    xyxw: dart.legacy(vector_math_64.Vector4),
    xyyx: dart.legacy(vector_math_64.Vector4),
    xyyy: dart.legacy(vector_math_64.Vector4),
    xyyz: dart.legacy(vector_math_64.Vector4),
    xyyw: dart.legacy(vector_math_64.Vector4),
    xyzx: dart.legacy(vector_math_64.Vector4),
    xyzy: dart.legacy(vector_math_64.Vector4),
    xyzz: dart.legacy(vector_math_64.Vector4),
    xyzw: dart.legacy(vector_math_64.Vector4),
    xywx: dart.legacy(vector_math_64.Vector4),
    xywy: dart.legacy(vector_math_64.Vector4),
    xywz: dart.legacy(vector_math_64.Vector4),
    xyww: dart.legacy(vector_math_64.Vector4),
    xzxx: dart.legacy(vector_math_64.Vector4),
    xzxy: dart.legacy(vector_math_64.Vector4),
    xzxz: dart.legacy(vector_math_64.Vector4),
    xzxw: dart.legacy(vector_math_64.Vector4),
    xzyx: dart.legacy(vector_math_64.Vector4),
    xzyy: dart.legacy(vector_math_64.Vector4),
    xzyz: dart.legacy(vector_math_64.Vector4),
    xzyw: dart.legacy(vector_math_64.Vector4),
    xzzx: dart.legacy(vector_math_64.Vector4),
    xzzy: dart.legacy(vector_math_64.Vector4),
    xzzz: dart.legacy(vector_math_64.Vector4),
    xzzw: dart.legacy(vector_math_64.Vector4),
    xzwx: dart.legacy(vector_math_64.Vector4),
    xzwy: dart.legacy(vector_math_64.Vector4),
    xzwz: dart.legacy(vector_math_64.Vector4),
    xzww: dart.legacy(vector_math_64.Vector4),
    xwxx: dart.legacy(vector_math_64.Vector4),
    xwxy: dart.legacy(vector_math_64.Vector4),
    xwxz: dart.legacy(vector_math_64.Vector4),
    xwxw: dart.legacy(vector_math_64.Vector4),
    xwyx: dart.legacy(vector_math_64.Vector4),
    xwyy: dart.legacy(vector_math_64.Vector4),
    xwyz: dart.legacy(vector_math_64.Vector4),
    xwyw: dart.legacy(vector_math_64.Vector4),
    xwzx: dart.legacy(vector_math_64.Vector4),
    xwzy: dart.legacy(vector_math_64.Vector4),
    xwzz: dart.legacy(vector_math_64.Vector4),
    xwzw: dart.legacy(vector_math_64.Vector4),
    xwwx: dart.legacy(vector_math_64.Vector4),
    xwwy: dart.legacy(vector_math_64.Vector4),
    xwwz: dart.legacy(vector_math_64.Vector4),
    xwww: dart.legacy(vector_math_64.Vector4),
    yxxx: dart.legacy(vector_math_64.Vector4),
    yxxy: dart.legacy(vector_math_64.Vector4),
    yxxz: dart.legacy(vector_math_64.Vector4),
    yxxw: dart.legacy(vector_math_64.Vector4),
    yxyx: dart.legacy(vector_math_64.Vector4),
    yxyy: dart.legacy(vector_math_64.Vector4),
    yxyz: dart.legacy(vector_math_64.Vector4),
    yxyw: dart.legacy(vector_math_64.Vector4),
    yxzx: dart.legacy(vector_math_64.Vector4),
    yxzy: dart.legacy(vector_math_64.Vector4),
    yxzz: dart.legacy(vector_math_64.Vector4),
    yxzw: dart.legacy(vector_math_64.Vector4),
    yxwx: dart.legacy(vector_math_64.Vector4),
    yxwy: dart.legacy(vector_math_64.Vector4),
    yxwz: dart.legacy(vector_math_64.Vector4),
    yxww: dart.legacy(vector_math_64.Vector4),
    yyxx: dart.legacy(vector_math_64.Vector4),
    yyxy: dart.legacy(vector_math_64.Vector4),
    yyxz: dart.legacy(vector_math_64.Vector4),
    yyxw: dart.legacy(vector_math_64.Vector4),
    yyyx: dart.legacy(vector_math_64.Vector4),
    yyyy: dart.legacy(vector_math_64.Vector4),
    yyyz: dart.legacy(vector_math_64.Vector4),
    yyyw: dart.legacy(vector_math_64.Vector4),
    yyzx: dart.legacy(vector_math_64.Vector4),
    yyzy: dart.legacy(vector_math_64.Vector4),
    yyzz: dart.legacy(vector_math_64.Vector4),
    yyzw: dart.legacy(vector_math_64.Vector4),
    yywx: dart.legacy(vector_math_64.Vector4),
    yywy: dart.legacy(vector_math_64.Vector4),
    yywz: dart.legacy(vector_math_64.Vector4),
    yyww: dart.legacy(vector_math_64.Vector4),
    yzxx: dart.legacy(vector_math_64.Vector4),
    yzxy: dart.legacy(vector_math_64.Vector4),
    yzxz: dart.legacy(vector_math_64.Vector4),
    yzxw: dart.legacy(vector_math_64.Vector4),
    yzyx: dart.legacy(vector_math_64.Vector4),
    yzyy: dart.legacy(vector_math_64.Vector4),
    yzyz: dart.legacy(vector_math_64.Vector4),
    yzyw: dart.legacy(vector_math_64.Vector4),
    yzzx: dart.legacy(vector_math_64.Vector4),
    yzzy: dart.legacy(vector_math_64.Vector4),
    yzzz: dart.legacy(vector_math_64.Vector4),
    yzzw: dart.legacy(vector_math_64.Vector4),
    yzwx: dart.legacy(vector_math_64.Vector4),
    yzwy: dart.legacy(vector_math_64.Vector4),
    yzwz: dart.legacy(vector_math_64.Vector4),
    yzww: dart.legacy(vector_math_64.Vector4),
    ywxx: dart.legacy(vector_math_64.Vector4),
    ywxy: dart.legacy(vector_math_64.Vector4),
    ywxz: dart.legacy(vector_math_64.Vector4),
    ywxw: dart.legacy(vector_math_64.Vector4),
    ywyx: dart.legacy(vector_math_64.Vector4),
    ywyy: dart.legacy(vector_math_64.Vector4),
    ywyz: dart.legacy(vector_math_64.Vector4),
    ywyw: dart.legacy(vector_math_64.Vector4),
    ywzx: dart.legacy(vector_math_64.Vector4),
    ywzy: dart.legacy(vector_math_64.Vector4),
    ywzz: dart.legacy(vector_math_64.Vector4),
    ywzw: dart.legacy(vector_math_64.Vector4),
    ywwx: dart.legacy(vector_math_64.Vector4),
    ywwy: dart.legacy(vector_math_64.Vector4),
    ywwz: dart.legacy(vector_math_64.Vector4),
    ywww: dart.legacy(vector_math_64.Vector4),
    zxxx: dart.legacy(vector_math_64.Vector4),
    zxxy: dart.legacy(vector_math_64.Vector4),
    zxxz: dart.legacy(vector_math_64.Vector4),
    zxxw: dart.legacy(vector_math_64.Vector4),
    zxyx: dart.legacy(vector_math_64.Vector4),
    zxyy: dart.legacy(vector_math_64.Vector4),
    zxyz: dart.legacy(vector_math_64.Vector4),
    zxyw: dart.legacy(vector_math_64.Vector4),
    zxzx: dart.legacy(vector_math_64.Vector4),
    zxzy: dart.legacy(vector_math_64.Vector4),
    zxzz: dart.legacy(vector_math_64.Vector4),
    zxzw: dart.legacy(vector_math_64.Vector4),
    zxwx: dart.legacy(vector_math_64.Vector4),
    zxwy: dart.legacy(vector_math_64.Vector4),
    zxwz: dart.legacy(vector_math_64.Vector4),
    zxww: dart.legacy(vector_math_64.Vector4),
    zyxx: dart.legacy(vector_math_64.Vector4),
    zyxy: dart.legacy(vector_math_64.Vector4),
    zyxz: dart.legacy(vector_math_64.Vector4),
    zyxw: dart.legacy(vector_math_64.Vector4),
    zyyx: dart.legacy(vector_math_64.Vector4),
    zyyy: dart.legacy(vector_math_64.Vector4),
    zyyz: dart.legacy(vector_math_64.Vector4),
    zyyw: dart.legacy(vector_math_64.Vector4),
    zyzx: dart.legacy(vector_math_64.Vector4),
    zyzy: dart.legacy(vector_math_64.Vector4),
    zyzz: dart.legacy(vector_math_64.Vector4),
    zyzw: dart.legacy(vector_math_64.Vector4),
    zywx: dart.legacy(vector_math_64.Vector4),
    zywy: dart.legacy(vector_math_64.Vector4),
    zywz: dart.legacy(vector_math_64.Vector4),
    zyww: dart.legacy(vector_math_64.Vector4),
    zzxx: dart.legacy(vector_math_64.Vector4),
    zzxy: dart.legacy(vector_math_64.Vector4),
    zzxz: dart.legacy(vector_math_64.Vector4),
    zzxw: dart.legacy(vector_math_64.Vector4),
    zzyx: dart.legacy(vector_math_64.Vector4),
    zzyy: dart.legacy(vector_math_64.Vector4),
    zzyz: dart.legacy(vector_math_64.Vector4),
    zzyw: dart.legacy(vector_math_64.Vector4),
    zzzx: dart.legacy(vector_math_64.Vector4),
    zzzy: dart.legacy(vector_math_64.Vector4),
    zzzz: dart.legacy(vector_math_64.Vector4),
    zzzw: dart.legacy(vector_math_64.Vector4),
    zzwx: dart.legacy(vector_math_64.Vector4),
    zzwy: dart.legacy(vector_math_64.Vector4),
    zzwz: dart.legacy(vector_math_64.Vector4),
    zzww: dart.legacy(vector_math_64.Vector4),
    zwxx: dart.legacy(vector_math_64.Vector4),
    zwxy: dart.legacy(vector_math_64.Vector4),
    zwxz: dart.legacy(vector_math_64.Vector4),
    zwxw: dart.legacy(vector_math_64.Vector4),
    zwyx: dart.legacy(vector_math_64.Vector4),
    zwyy: dart.legacy(vector_math_64.Vector4),
    zwyz: dart.legacy(vector_math_64.Vector4),
    zwyw: dart.legacy(vector_math_64.Vector4),
    zwzx: dart.legacy(vector_math_64.Vector4),
    zwzy: dart.legacy(vector_math_64.Vector4),
    zwzz: dart.legacy(vector_math_64.Vector4),
    zwzw: dart.legacy(vector_math_64.Vector4),
    zwwx: dart.legacy(vector_math_64.Vector4),
    zwwy: dart.legacy(vector_math_64.Vector4),
    zwwz: dart.legacy(vector_math_64.Vector4),
    zwww: dart.legacy(vector_math_64.Vector4),
    wxxx: dart.legacy(vector_math_64.Vector4),
    wxxy: dart.legacy(vector_math_64.Vector4),
    wxxz: dart.legacy(vector_math_64.Vector4),
    wxxw: dart.legacy(vector_math_64.Vector4),
    wxyx: dart.legacy(vector_math_64.Vector4),
    wxyy: dart.legacy(vector_math_64.Vector4),
    wxyz: dart.legacy(vector_math_64.Vector4),
    wxyw: dart.legacy(vector_math_64.Vector4),
    wxzx: dart.legacy(vector_math_64.Vector4),
    wxzy: dart.legacy(vector_math_64.Vector4),
    wxzz: dart.legacy(vector_math_64.Vector4),
    wxzw: dart.legacy(vector_math_64.Vector4),
    wxwx: dart.legacy(vector_math_64.Vector4),
    wxwy: dart.legacy(vector_math_64.Vector4),
    wxwz: dart.legacy(vector_math_64.Vector4),
    wxww: dart.legacy(vector_math_64.Vector4),
    wyxx: dart.legacy(vector_math_64.Vector4),
    wyxy: dart.legacy(vector_math_64.Vector4),
    wyxz: dart.legacy(vector_math_64.Vector4),
    wyxw: dart.legacy(vector_math_64.Vector4),
    wyyx: dart.legacy(vector_math_64.Vector4),
    wyyy: dart.legacy(vector_math_64.Vector4),
    wyyz: dart.legacy(vector_math_64.Vector4),
    wyyw: dart.legacy(vector_math_64.Vector4),
    wyzx: dart.legacy(vector_math_64.Vector4),
    wyzy: dart.legacy(vector_math_64.Vector4),
    wyzz: dart.legacy(vector_math_64.Vector4),
    wyzw: dart.legacy(vector_math_64.Vector4),
    wywx: dart.legacy(vector_math_64.Vector4),
    wywy: dart.legacy(vector_math_64.Vector4),
    wywz: dart.legacy(vector_math_64.Vector4),
    wyww: dart.legacy(vector_math_64.Vector4),
    wzxx: dart.legacy(vector_math_64.Vector4),
    wzxy: dart.legacy(vector_math_64.Vector4),
    wzxz: dart.legacy(vector_math_64.Vector4),
    wzxw: dart.legacy(vector_math_64.Vector4),
    wzyx: dart.legacy(vector_math_64.Vector4),
    wzyy: dart.legacy(vector_math_64.Vector4),
    wzyz: dart.legacy(vector_math_64.Vector4),
    wzyw: dart.legacy(vector_math_64.Vector4),
    wzzx: dart.legacy(vector_math_64.Vector4),
    wzzy: dart.legacy(vector_math_64.Vector4),
    wzzz: dart.legacy(vector_math_64.Vector4),
    wzzw: dart.legacy(vector_math_64.Vector4),
    wzwx: dart.legacy(vector_math_64.Vector4),
    wzwy: dart.legacy(vector_math_64.Vector4),
    wzwz: dart.legacy(vector_math_64.Vector4),
    wzww: dart.legacy(vector_math_64.Vector4),
    wwxx: dart.legacy(vector_math_64.Vector4),
    wwxy: dart.legacy(vector_math_64.Vector4),
    wwxz: dart.legacy(vector_math_64.Vector4),
    wwxw: dart.legacy(vector_math_64.Vector4),
    wwyx: dart.legacy(vector_math_64.Vector4),
    wwyy: dart.legacy(vector_math_64.Vector4),
    wwyz: dart.legacy(vector_math_64.Vector4),
    wwyw: dart.legacy(vector_math_64.Vector4),
    wwzx: dart.legacy(vector_math_64.Vector4),
    wwzy: dart.legacy(vector_math_64.Vector4),
    wwzz: dart.legacy(vector_math_64.Vector4),
    wwzw: dart.legacy(vector_math_64.Vector4),
    wwwx: dart.legacy(vector_math_64.Vector4),
    wwwy: dart.legacy(vector_math_64.Vector4),
    wwwz: dart.legacy(vector_math_64.Vector4),
    wwww: dart.legacy(vector_math_64.Vector4),
    r: dart.legacy(core.double),
    g: dart.legacy(core.double),
    b: dart.legacy(core.double),
    ...
    rg: dart.legacy(vector_math_64.Vector2),
    rb: dart.legacy(vector_math_64.Vector2),
    ra: dart.legacy(vector_math_64.Vector2),
    gr: dart.legacy(vector_math_64.Vector2),
    gg: dart.legacy(vector_math_64.Vector2),
    gb: dart.legacy(vector_math_64.Vector2),
    ga: dart.legacy(vector_math_64.Vector2),
    br: dart.legacy(vector_math_64.Vector2),
    bg: dart.legacy(vector_math_64.Vector2),
    bb: dart.legacy(vector_math_64.Vector2),
    ba: dart.legacy(vector_math_64.Vector2),
    ar: dart.legacy(vector_math_64.Vector2),
    ag: dart.legacy(vector_math_64.Vector2),
    ab: dart.legacy(vector_math_64.Vector2),
    aa: dart.legacy(vector_math_64.Vector2),
    rrr: dart.legacy(vector_math_64.Vector3),
    rrg: dart.legacy(vector_math_64.Vector3),
    rrb: dart.legacy(vector_math_64.Vector3),
    rra: dart.legacy(vector_math_64.Vector3),
    rgr: dart.legacy(vector_math_64.Vector3),
    rgg: dart.legacy(vector_math_64.Vector3),
    rgb: dart.legacy(vector_math_64.Vector3),
    rga: dart.legacy(vector_math_64.Vector3),
    rbr: dart.legacy(vector_math_64.Vector3),
    rbg: dart.legacy(vector_math_64.Vector3),
    rbb: dart.legacy(vector_math_64.Vector3),
    rba: dart.legacy(vector_math_64.Vector3),
    rar: dart.legacy(vector_math_64.Vector3),
    rag: dart.legacy(vector_math_64.Vector3),
    rab: dart.legacy(vector_math_64.Vector3),
    raa: dart.legacy(vector_math_64.Vector3),
    grr: dart.legacy(vector_math_64.Vector3),
    grg: dart.legacy(vector_math_64.Vector3),
    grb: dart.legacy(vector_math_64.Vector3),
    gra: dart.legacy(vector_math_64.Vector3),
    ggr: dart.legacy(vector_math_64.Vector3),
    ggg: dart.legacy(vector_math_64.Vector3),
    ggb: dart.legacy(vector_math_64.Vector3),
    gga: dart.legacy(vector_math_64.Vector3),
    gbr: dart.legacy(vector_math_64.Vector3),
    gbg: dart.legacy(vector_math_64.Vector3),
    gbb: dart.legacy(vector_math_64.Vector3),
    gba: dart.legacy(vector_math_64.Vector3),
    gar: dart.legacy(vector_math_64.Vector3),
    gag: dart.legacy(vector_math_64.Vector3),
    gab: dart.legacy(vector_math_64.Vector3),
    gaa: dart.legacy(vector_math_64.Vector3),
    brr: dart.legacy(vector_math_64.Vector3),
    brg: dart.legacy(vector_math_64.Vector3),
    brb: dart.legacy(vector_math_64.Vector3),
    bra: dart.legacy(vector_math_64.Vector3),
    bgr: dart.legacy(vector_math_64.Vector3),
    bgg: dart.legacy(vector_math_64.Vector3),
    bgb: dart.legacy(vector_math_64.Vector3),
    bga: dart.legacy(vector_math_64.Vector3),
    bbr: dart.legacy(vector_math_64.Vector3),
    bbg: dart.legacy(vector_math_64.Vector3),
    bbb: dart.legacy(vector_math_64.Vector3),
    bba: dart.legacy(vector_math_64.Vector3),
    bar: dart.legacy(vector_math_64.Vector3),
    bag: dart.legacy(vector_math_64.Vector3),
    bab: dart.legacy(vector_math_64.Vector3),
    baa: dart.legacy(vector_math_64.Vector3),
    arr: dart.legacy(vector_math_64.Vector3),
    arg: dart.legacy(vector_math_64.Vector3),
    arb: dart.legacy(vector_math_64.Vector3),
    ara: dart.legacy(vector_math_64.Vector3),
    agr: dart.legacy(vector_math_64.Vector3),
    agg: dart.legacy(vector_math_64.Vector3),
    agb: dart.legacy(vector_math_64.Vector3),
    aga: dart.legacy(vector_math_64.Vector3),
    abr: dart.legacy(vector_math_64.Vector3),
    abg: dart.legacy(vector_math_64.Vector3),
    abb: dart.legacy(vector_math_64.Vector3),
    aba: dart.legacy(vector_math_64.Vector3),
    aar: dart.legacy(vector_math_64.Vector3),
    aag: dart.legacy(vector_math_64.Vector3),
    aab: dart.legacy(vector_math_64.Vector3),
    aaa: dart.legacy(vector_math_64.Vector3),
    rrrr: dart.legacy(vector_math_64.Vector4),
    rrrg: dart.legacy(vector_math_64.Vector4),
    rrrb: dart.legacy(vector_math_64.Vector4),
    rrra: dart.legacy(vector_math_64.Vector4),
    rrgr: dart.legacy(vector_math_64.Vector4),
    rrgg: dart.legacy(vector_math_64.Vector4),
    rrgb: dart.legacy(vector_math_64.Vector4),
    rrga: dart.legacy(vector_math_64.Vector4),
    rrbr: dart.legacy(vector_math_64.Vector4),
    rrbg: dart.legacy(vector_math_64.Vector4),
    rrbb: dart.legacy(vector_math_64.Vector4),
    rrba: dart.legacy(vector_math_64.Vector4),
    rrar: dart.legacy(vector_math_64.Vector4),
    rrag: dart.legacy(vector_math_64.Vector4),
    rrab: dart.legacy(vector_math_64.Vector4),
    rraa: dart.legacy(vector_math_64.Vector4),
    rgrr: dart.legacy(vector_math_64.Vector4),
    rgrg: dart.legacy(vector_math_64.Vector4),
    rgrb: dart.legacy(vector_math_64.Vector4),
    rgra: dart.legacy(vector_math_64.Vector4),
    rggr: dart.legacy(vector_math_64.Vector4),
    rggg: dart.legacy(vector_math_64.Vector4),
    rggb: dart.legacy(vector_math_64.Vector4),
    rgga: dart.legacy(vector_math_64.Vector4),
    rgbr: dart.legacy(vector_math_64.Vector4),
    rgbg: dart.legacy(vector_math_64.Vector4),
    rgbb: dart.legacy(vector_math_64.Vector4),
    rgba: dart.legacy(vector_math_64.Vector4),
    rgar: dart.legacy(vector_math_64.Vector4),
    rgag: dart.legacy(vector_math_64.Vector4),
    rgab: dart.legacy(vector_math_64.Vector4),
    rgaa: dart.legacy(vector_math_64.Vector4),
    rbrr: dart.legacy(vector_math_64.Vector4),
    rbrg: dart.legacy(vector_math_64.Vector4),
    rbrb: dart.legacy(vector_math_64.Vector4),
    rbra: dart.legacy(vector_math_64.Vector4),
    rbgr: dart.legacy(vector_math_64.Vector4),
    rbgg: dart.legacy(vector_math_64.Vector4),
    rbgb: dart.legacy(vector_math_64.Vector4),
    rbga: dart.legacy(vector_math_64.Vector4),
    rbbr: dart.legacy(vector_math_64.Vector4),
    rbbg: dart.legacy(vector_math_64.Vector4),
    rbbb: dart.legacy(vector_math_64.Vector4),
    rbba: dart.legacy(vector_math_64.Vector4),
    rbar: dart.legacy(vector_math_64.Vector4),
    rbag: dart.legacy(vector_math_64.Vector4),
    rbab: dart.legacy(vector_math_64.Vector4),
    rbaa: dart.legacy(vector_math_64.Vector4),
    rarr: dart.legacy(vector_math_64.Vector4),
    rarg: dart.legacy(vector_math_64.Vector4),
    rarb: dart.legacy(vector_math_64.Vector4),
    rara: dart.legacy(vector_math_64.Vector4),
    ragr: dart.legacy(vector_math_64.Vector4),
    ragg: dart.legacy(vector_math_64.Vector4),
    ragb: dart.legacy(vector_math_64.Vector4),
    raga: dart.legacy(vector_math_64.Vector4),
    rabr: dart.legacy(vector_math_64.Vector4),
    rabg: dart.legacy(vector_math_64.Vector4),
    rabb: dart.legacy(vector_math_64.Vector4),
    raba: dart.legacy(vector_math_64.Vector4),
    raar: dart.legacy(vector_math_64.Vector4),
    raag: dart.legacy(vector_math_64.Vector4),
    raab: dart.legacy(vector_math_64.Vector4),
    raaa: dart.legacy(vector_math_64.Vector4),
    grrr: dart.legacy(vector_math_64.Vector4),
    grrg: dart.legacy(vector_math_64.Vector4),
    grrb: dart.legacy(vector_math_64.Vector4),
    grra: dart.legacy(vector_math_64.Vector4),
    grgr: dart.legacy(vector_math_64.Vector4),
    grgg: dart.legacy(vector_math_64.Vector4),
    grgb: dart.legacy(vector_math_64.Vector4),
    grga: dart.legacy(vector_math_64.Vector4),
    grbr: dart.legacy(vector_math_64.Vector4),
    grbg: dart.legacy(vector_math_64.Vector4),
    grbb: dart.legacy(vector_math_64.Vector4),
    grba: dart.legacy(vector_math_64.Vector4),
    grar: dart.legacy(vector_math_64.Vector4),
    grag: dart.legacy(vector_math_64.Vector4),
    grab: dart.legacy(vector_math_64.Vector4),
    graa: dart.legacy(vector_math_64.Vector4),
    ggrr: dart.legacy(vector_math_64.Vector4),
    ggrg: dart.legacy(vector_math_64.Vector4),
    ggrb: dart.legacy(vector_math_64.Vector4),
    ggra: dart.legacy(vector_math_64.Vector4),
    gggr: dart.legacy(vector_math_64.Vector4),
    gggg: dart.legacy(vector_math_64.Vector4),
    gggb: dart.legacy(vector_math_64.Vector4),
    ggga: dart.legacy(vector_math_64.Vector4),
    ggbr: dart.legacy(vector_math_64.Vector4),
    ggbg: dart.legacy(vector_math_64.Vector4),
    ggbb: dart.legacy(vector_math_64.Vector4),
    ggba: dart.legacy(vector_math_64.Vector4),
    ggar: dart.legacy(vector_math_64.Vector4),
    ggag: dart.legacy(vector_math_64.Vector4),
    ggab: dart.legacy(vector_math_64.Vector4),
    ggaa: dart.legacy(vector_math_64.Vector4),
    gbrr: dart.legacy(vector_math_64.Vector4),
    gbrg: dart.legacy(vector_math_64.Vector4),
    gbrb: dart.legacy(vector_math_64.Vector4),
    gbra: dart.legacy(vector_math_64.Vector4),
    gbgr: dart.legacy(vector_math_64.Vector4),
    gbgg: dart.legacy(vector_math_64.Vector4),
    gbgb: dart.legacy(vector_math_64.Vector4),
    gbga: dart.legacy(vector_math_64.Vector4),
    gbbr: dart.legacy(vector_math_64.Vector4),
    gbbg: dart.legacy(vector_math_64.Vector4),
    gbbb: dart.legacy(vector_math_64.Vector4),
    gbba: dart.legacy(vector_math_64.Vector4),
    gbar: dart.legacy(vector_math_64.Vector4),
    gbag: dart.legacy(vector_math_64.Vector4),
    gbab: dart.legacy(vector_math_64.Vector4),
    gbaa: dart.legacy(vector_math_64.Vector4),
    garr: dart.legacy(vector_math_64.Vector4),
    garg: dart.legacy(vector_math_64.Vector4),
    garb: dart.legacy(vector_math_64.Vector4),
    gara: dart.legacy(vector_math_64.Vector4),
    gagr: dart.legacy(vector_math_64.Vector4),
    gagg: dart.legacy(vector_math_64.Vector4),
    gagb: dart.legacy(vector_math_64.Vector4),
    gaga: dart.legacy(vector_math_64.Vector4),
    gabr: dart.legacy(vector_math_64.Vector4),
    gabg: dart.legacy(vector_math_64.Vector4),
    gabb: dart.legacy(vector_math_64.Vector4),
    gaba: dart.legacy(vector_math_64.Vector4),
    gaar: dart.legacy(vector_math_64.Vector4),
    gaag: dart.legacy(vector_math_64.Vector4),
    gaab: dart.legacy(vector_math_64.Vector4),
    gaaa: dart.legacy(vector_math_64.Vector4),
    brrr: dart.legacy(vector_math_64.Vector4),
    brrg: dart.legacy(vector_math_64.Vector4),
    brrb: dart.legacy(vector_math_64.Vector4),
    brra: dart.legacy(vector_math_64.Vector4),
    brgr: dart.legacy(vector_math_64.Vector4),
    brgg: dart.legacy(vector_math_64.Vector4),
    brgb: dart.legacy(vector_math_64.Vector4),
    brga: dart.legacy(vector_math_64.Vector4),
    brbr: dart.legacy(vector_math_64.Vector4),
    brbg: dart.legacy(vector_math_64.Vector4),
    brbb: dart.legacy(vector_math_64.Vector4),
    brba: dart.legacy(vector_math_64.Vector4),
    brar: dart.legacy(vector_math_64.Vector4),
    brag: dart.legacy(vector_math_64.Vector4),
    brab: dart.legacy(vector_math_64.Vector4),
    braa: dart.legacy(vector_math_64.Vector4),
    bgrr: dart.legacy(vector_math_64.Vector4),
    bgrg: dart.legacy(vector_math_64.Vector4),
    bgrb: dart.legacy(vector_math_64.Vector4),
    bgra: dart.legacy(vector_math_64.Vector4),
    bggr: dart.legacy(vector_math_64.Vector4),
    bggg: dart.legacy(vector_math_64.Vector4),
    bggb: dart.legacy(vector_math_64.Vector4),
    bgga: dart.legacy(vector_math_64.Vector4),
    bgbr: dart.legacy(vector_math_64.Vector4),
    bgbg: dart.legacy(vector_math_64.Vector4),
    bgbb: dart.legacy(vector_math_64.Vector4),
    bgba: dart.legacy(vector_math_64.Vector4),
    bgar: dart.legacy(vector_math_64.Vector4),
    bgag: dart.legacy(vector_math_64.Vector4),
    bgab: dart.legacy(vector_math_64.Vector4),
    bgaa: dart.legacy(vector_math_64.Vector4),
    bbrr: dart.legacy(vector_math_64.Vector4),
    bbrg: dart.legacy(vector_math_64.Vector4),
    bbrb: dart.legacy(vector_math_64.Vector4),
    bbra: dart.legacy(vector_math_64.Vector4),
    bbgr: dart.legacy(vector_math_64.Vector4),
    bbgg: dart.legacy(vector_math_64.Vector4),
    bbgb: dart.legacy(vector_math_64.Vector4),
    bbga: dart.legacy(vector_math_64.Vector4),
    bbbr: dart.legacy(vector_math_64.Vector4),
    bbbg: dart.legacy(vector_math_64.Vector4),
    bbbb: dart.legacy(vector_math_64.Vector4),
    bbba: dart.legacy(vector_math_64.Vector4),
    bbar: dart.legacy(vector_math_64.Vector4),
    bbag: dart.legacy(vector_math_64.Vector4),
    bbab: dart.legacy(vector_math_64.Vector4),
    bbaa: dart.legacy(vector_math_64.Vector4),
    barr: dart.legacy(vector_math_64.Vector4),
    barg: dart.legacy(vector_math_64.Vector4),
    barb: dart.legacy(vector_math_64.Vector4),
    bara: dart.legacy(vector_math_64.Vector4),
    bagr: dart.legacy(vector_math_64.Vector4),
    bagg: dart.legacy(vector_math_64.Vector4),
    bagb: dart.legacy(vector_math_64.Vector4),
    baga: dart.legacy(vector_math_64.Vector4),
    babr: dart.legacy(vector_math_64.Vector4),
    babg: dart.legacy(vector_math_64.Vector4),
    babb: dart.legacy(vector_math_64.Vector4),
    baba: dart.legacy(vector_math_64.Vector4),
    baar: dart.legacy(vector_math_64.Vector4),
    baag: dart.legacy(vector_math_64.Vector4),
    baab: dart.legacy(vector_math_64.Vector4),
    baaa: dart.legacy(vector_math_64.Vector4),
    arrr: dart.legacy(vector_math_64.Vector4),
    arrg: dart.legacy(vector_math_64.Vector4),
    arrb: dart.legacy(vector_math_64.Vector4),
    arra: dart.legacy(vector_math_64.Vector4),
    argr: dart.legacy(vector_math_64.Vector4),
    argg: dart.legacy(vector_math_64.Vector4),
    argb: dart.legacy(vector_math_64.Vector4),
    arga: dart.legacy(vector_math_64.Vector4),
    arbr: dart.legacy(vector_math_64.Vector4),
    arbg: dart.legacy(vector_math_64.Vector4),
    arbb: dart.legacy(vector_math_64.Vector4),
    arba: dart.legacy(vector_math_64.Vector4),
    arar: dart.legacy(vector_math_64.Vector4),
    arag: dart.legacy(vector_math_64.Vector4),
    arab: dart.legacy(vector_math_64.Vector4),
    araa: dart.legacy(vector_math_64.Vector4),
    agrr: dart.legacy(vector_math_64.Vector4),
    agrg: dart.legacy(vector_math_64.Vector4),
    agrb: dart.legacy(vector_math_64.Vector4),
    agra: dart.legacy(vector_math_64.Vector4),
    aggr: dart.legacy(vector_math_64.Vector4),
    aggg: dart.legacy(vector_math_64.Vector4),
    aggb: dart.legacy(vector_math_64.Vector4),
    agga: dart.legacy(vector_math_64.Vector4),
    agbr: dart.legacy(vector_math_64.Vector4),
    agbg: dart.legacy(vector_math_64.Vector4),
    agbb: dart.legacy(vector_math_64.Vector4),
    agba: dart.legacy(vector_math_64.Vector4),
    agar: dart.legacy(vector_math_64.Vector4),
    agag: dart.legacy(vector_math_64.Vector4),
    agab: dart.legacy(vector_math_64.Vector4),
    agaa: dart.legacy(vector_math_64.Vector4),
    abrr: dart.legacy(vector_math_64.Vector4),
    abrg: dart.legacy(vector_math_64.Vector4),
    abrb: dart.legacy(vector_math_64.Vector4),
    abra: dart.legacy(vector_math_64.Vector4),
    abgr: dart.legacy(vector_math_64.Vector4),
    abgg: dart.legacy(vector_math_64.Vector4),
    abgb: dart.legacy(vector_math_64.Vector4),
    abga: dart.legacy(vector_math_64.Vector4),
    abbr: dart.legacy(vector_math_64.Vector4),
    abbg: dart.legacy(vector_math_64.Vector4),
    abbb: dart.legacy(vector_math_64.Vector4),
    abba: dart.legacy(vector_math_64.Vector4),
    abar: dart.legacy(vector_math_64.Vector4),
    abag: dart.legacy(vector_math_64.Vector4),
    abab: dart.legacy(vector_math_64.Vector4),
    abaa: dart.legacy(vector_math_64.Vector4),
    aarr: dart.legacy(vector_math_64.Vector4),
    aarg: dart.legacy(vector_math_64.Vector4),
    aarb: dart.legacy(vector_math_64.Vector4),
    aara: dart.legacy(vector_math_64.Vector4),
    aagr: dart.legacy(vector_math_64.Vector4),
    aagg: dart.legacy(vector_math_64.Vector4),
    aagb: dart.legacy(vector_math_64.Vector4),
    aaga: dart.legacy(vector_math_64.Vector4),
    aabr: dart.legacy(vector_math_64.Vector4),
    aabg: dart.legacy(vector_math_64.Vector4),
    aabb: dart.legacy(vector_math_64.Vector4),
    aaba: dart.legacy(vector_math_64.Vector4),
    aaar: dart.legacy(vector_math_64.Vector4),
    aaag: dart.legacy(vector_math_64.Vector4),
    aaab: dart.legacy(vector_math_64.Vector4),
    aaaa: dart.legacy(vector_math_64.Vector4),
    ss: dart.legacy(vector_math_64.Vector2),
    st: dart.legacy(vector_math_64.Vector2),
    sp: dart.legacy(vector_math_64.Vector2),
    sq: dart.legacy(vector_math_64.Vector2),
    ts: dart.legacy(vector_math_64.Vector2),
    tt: dart.legacy(vector_math_64.Vector2),
    tp: dart.legacy(vector_math_64.Vector2),
    tq: dart.legacy(vector_math_64.Vector2),
    ps: dart.legacy(vector_math_64.Vector2),
    pt: dart.legacy(vector_math_64.Vector2),
    pp: dart.legacy(vector_math_64.Vector2),
    pq: dart.legacy(vector_math_64.Vector2),
    qs: dart.legacy(vector_math_64.Vector2),
    qt: dart.legacy(vector_math_64.Vector2),
    qp: dart.legacy(vector_math_64.Vector2),
    qq: dart.legacy(vector_math_64.Vector2),
    sss: dart.legacy(vector_math_64.Vector3),
    sst: dart.legacy(vector_math_64.Vector3),
    ssp: dart.legacy(vector_math_64.Vector3),
    ssq: dart.legacy(vector_math_64.Vector3),
    sts: dart.legacy(vector_math_64.Vector3),
    stt: dart.legacy(vector_math_64.Vector3),
    stp: dart.legacy(vector_math_64.Vector3),
    stq: dart.legacy(vector_math_64.Vector3),
    sps: dart.legacy(vector_math_64.Vector3),
    spt: dart.legacy(vector_math_64.Vector3),
    spp: dart.legacy(vector_math_64.Vector3),
    spq: dart.legacy(vector_math_64.Vector3),
    sqs: dart.legacy(vector_math_64.Vector3),
    sqt: dart.legacy(vector_math_64.Vector3),
    sqp: dart.legacy(vector_math_64.Vector3),
    sqq: dart.legacy(vector_math_64.Vector3),
    tss: dart.legacy(vector_math_64.Vector3),
    tst: dart.legacy(vector_math_64.Vector3),
    tsp: dart.legacy(vector_math_64.Vector3),
    tsq: dart.legacy(vector_math_64.Vector3),
    tts: dart.legacy(vector_math_64.Vector3),
    ttt: dart.legacy(vector_math_64.Vector3),
    ttp: dart.legacy(vector_math_64.Vector3),
    ttq: dart.legacy(vector_math_64.Vector3),
    tps: dart.legacy(vector_math_64.Vector3),
    tpt: dart.legacy(vector_math_64.Vector3),
    tpp: dart.legacy(vector_math_64.Vector3),
    tpq: dart.legacy(vector_math_64.Vector3),
    tqs: dart.legacy(vector_math_64.Vector3),
    tqt: dart.legacy(vector_math_64.Vector3),
    tqp: dart.legacy(vector_math_64.Vector3),
    tqq: dart.legacy(vector_math_64.Vector3),
    pss: dart.legacy(vector_math_64.Vector3),
    pst: dart.legacy(vector_math_64.Vector3),
    psp: dart.legacy(vector_math_64.Vector3),
    psq: dart.legacy(vector_math_64.Vector3),
    pts: dart.legacy(vector_math_64.Vector3),
    ptt: dart.legacy(vector_math_64.Vector3),
    ptp: dart.legacy(vector_math_64.Vector3),
    ptq: dart.legacy(vector_math_64.Vector3),
    pps: dart.legacy(vector_math_64.Vector3),
    ppt: dart.legacy(vector_math_64.Vector3),
    ppp: dart.legacy(vector_math_64.Vector3),
    ppq: dart.legacy(vector_math_64.Vector3),
    pqs: dart.legacy(vector_math_64.Vector3),
    pqt: dart.legacy(vector_math_64.Vector3),
    pqp: dart.legacy(vector_math_64.Vector3),
    pqq: dart.legacy(vector_math_64.Vector3),
    qss: dart.legacy(vector_math_64.Vector3),
    qst: dart.legacy(vector_math_64.Vector3),
    qsp: dart.legacy(vector_math_64.Vector3),
    qsq: dart.legacy(vector_math_64.Vector3),
    qts: dart.legacy(vector_math_64.Vector3),
    qtt: dart.legacy(vector_math_64.Vector3),
    qtp: dart.legacy(vector_math_64.Vector3),
    qtq: dart.legacy(vector_math_64.Vector3),
    qps: dart.legacy(vector_math_64.Vector3),
    qpt: dart.legacy(vector_math_64.Vector3),
    qpp: dart.legacy(vector_math_64.Vector3),
    qpq: dart.legacy(vector_math_64.Vector3),
    qqs: dart.legacy(vector_math_64.Vector3),
    qqt: dart.legacy(vector_math_64.Vector3),
    qqp: dart.legacy(vector_math_64.Vector3),
    qqq: dart.legacy(vector_math_64.Vector3),
    ssss: dart.legacy(vector_math_64.Vector4),
    ssst: dart.legacy(vector_math_64.Vector4),
    sssp: dart.legacy(vector_math_64.Vector4),
    sssq: dart.legacy(vector_math_64.Vector4),
    ssts: dart.legacy(vector_math_64.Vector4),
    sstt: dart.legacy(vector_math_64.Vector4),
    sstp: dart.legacy(vector_math_64.Vector4),
    sstq: dart.legacy(vector_math_64.Vector4),
    ssps: dart.legacy(vector_math_64.Vector4),
    sspt: dart.legacy(vector_math_64.Vector4),
    sspp: dart.legacy(vector_math_64.Vector4),
    sspq: dart.legacy(vector_math_64.Vector4),
    ssqs: dart.legacy(vector_math_64.Vector4),
    ssqt: dart.legacy(vector_math_64.Vector4),
    ssqp: dart.legacy(vector_math_64.Vector4),
    ssqq: dart.legacy(vector_math_64.Vector4),
    stss: dart.legacy(vector_math_64.Vector4),
    stst: dart.legacy(vector_math_64.Vector4),
    stsp: dart.legacy(vector_math_64.Vector4),
    stsq: dart.legacy(vector_math_64.Vector4),
    stts: dart.legacy(vector_math_64.Vector4),
    sttt: dart.legacy(vector_math_64.Vector4),
    sttp: dart.legacy(vector_math_64.Vector4),
    sttq: dart.legacy(vector_math_64.Vector4),
    stps: dart.legacy(vector_math_64.Vector4),
    stpt: dart.legacy(vector_math_64.Vector4),
    stpp: dart.legacy(vector_math_64.Vector4),
    stpq: dart.legacy(vector_math_64.Vector4),
    stqs: dart.legacy(vector_math_64.Vector4),
    stqt: dart.legacy(vector_math_64.Vector4),
    stqp: dart.legacy(vector_math_64.Vector4),
    stqq: dart.legacy(vector_math_64.Vector4),
    spss: dart.legacy(vector_math_64.Vector4),
    spst: dart.legacy(vector_math_64.Vector4),
    spsp: dart.legacy(vector_math_64.Vector4),
    spsq: dart.legacy(vector_math_64.Vector4),
    spts: dart.legacy(vector_math_64.Vector4),
    sptt: dart.legacy(vector_math_64.Vector4),
    sptp: dart.legacy(vector_math_64.Vector4),
    sptq: dart.legacy(vector_math_64.Vector4),
    spps: dart.legacy(vector_math_64.Vector4),
    sppt: dart.legacy(vector_math_64.Vector4),
    sppp: dart.legacy(vector_math_64.Vector4),
    sppq: dart.legacy(vector_math_64.Vector4),
    spqs: dart.legacy(vector_math_64.Vector4),
    spqt: dart.legacy(vector_math_64.Vector4),
    spqp: dart.legacy(vector_math_64.Vector4),
    spqq: dart.legacy(vector_math_64.Vector4),
    sqss: dart.legacy(vector_math_64.Vector4),
    sqst: dart.legacy(vector_math_64.Vector4),
    sqsp: dart.legacy(vector_math_64.Vector4),
    sqsq: dart.legacy(vector_math_64.Vector4),
    sqts: dart.legacy(vector_math_64.Vector4),
    sqtt: dart.legacy(vector_math_64.Vector4),
    sqtp: dart.legacy(vector_math_64.Vector4),
    sqtq: dart.legacy(vector_math_64.Vector4),
    sqps: dart.legacy(vector_math_64.Vector4),
    sqpt: dart.legacy(vector_math_64.Vector4),
    sqpp: dart.legacy(vector_math_64.Vector4),
    sqpq: dart.legacy(vector_math_64.Vector4),
    sqqs: dart.legacy(vector_math_64.Vector4),
    sqqt: dart.legacy(vector_math_64.Vector4),
    sqqp: dart.legacy(vector_math_64.Vector4),
    sqqq: dart.legacy(vector_math_64.Vector4),
    tsss: dart.legacy(vector_math_64.Vector4),
    tsst: dart.legacy(vector_math_64.Vector4),
    tssp: dart.legacy(vector_math_64.Vector4),
    tssq: dart.legacy(vector_math_64.Vector4),
    tsts: dart.legacy(vector_math_64.Vector4),
    tstt: dart.legacy(vector_math_64.Vector4),
    tstp: dart.legacy(vector_math_64.Vector4),
    tstq: dart.legacy(vector_math_64.Vector4),
    tsps: dart.legacy(vector_math_64.Vector4),
    tspt: dart.legacy(vector_math_64.Vector4),
    tspp: dart.legacy(vector_math_64.Vector4),
    tspq: dart.legacy(vector_math_64.Vector4),
    tsqs: dart.legacy(vector_math_64.Vector4),
    tsqt: dart.legacy(vector_math_64.Vector4),
    tsqp: dart.legacy(vector_math_64.Vector4),
    tsqq: dart.legacy(vector_math_64.Vector4),
    ttss: dart.legacy(vector_math_64.Vector4),
    ttst: dart.legacy(vector_math_64.Vector4),
    ttsp: dart.legacy(vector_math_64.Vector4),
    ttsq: dart.legacy(vector_math_64.Vector4),
    ttts: dart.legacy(vector_math_64.Vector4),
    tttt: dart.legacy(vector_math_64.Vector4),
    tttp: dart.legacy(vector_math_64.Vector4),
    tttq: dart.legacy(vector_math_64.Vector4),
    ttps: dart.legacy(vector_math_64.Vector4),
    ttpt: dart.legacy(vector_math_64.Vector4),
    ttpp: dart.legacy(vector_math_64.Vector4),
    ttpq: dart.legacy(vector_math_64.Vector4),
    ttqs: dart.legacy(vector_math_64.Vector4),
    ttqt: dart.legacy(vector_math_64.Vector4),
    ttqp: dart.legacy(vector_math_64.Vector4),
    ttqq: dart.legacy(vector_math_64.Vector4),
    tpss: dart.legacy(vector_math_64.Vector4),
    tpst: dart.legacy(vector_math_64.Vector4),
    tpsp: dart.legacy(vector_math_64.Vector4),
    tpsq: dart.legacy(vector_math_64.Vector4),
    tpts: dart.legacy(vector_math_64.Vector4),
    tptt: dart.legacy(vector_math_64.Vector4),
    tptp: dart.legacy(vector_math_64.Vector4),
    tptq: dart.legacy(vector_math_64.Vector4),
    tpps: dart.legacy(vector_math_64.Vector4),
    tppt: dart.legacy(vector_math_64.Vector4),
    tppp: dart.legacy(vector_math_64.Vector4),
    tppq: dart.legacy(vector_math_64.Vector4),
    tpqs: dart.legacy(vector_math_64.Vector4),
    tpqt: dart.legacy(vector_math_64.Vector4),
    tpqp: dart.legacy(vector_math_64.Vector4),
    tpqq: dart.legacy(vector_math_64.Vector4),
    tqss: dart.legacy(vector_math_64.Vector4),
    tqst: dart.legacy(vector_math_64.Vector4),
    tqsp: dart.legacy(vector_math_64.Vector4),
    tqsq: dart.legacy(vector_math_64.Vector4),
    tqts: dart.legacy(vector_math_64.Vector4),
    tqtt: dart.legacy(vector_math_64.Vector4),
    tqtp: dart.legacy(vector_math_64.Vector4),
    tqtq: dart.legacy(vector_math_64.Vector4),
    tqps: dart.legacy(vector_math_64.Vector4),
    tqpt: dart.legacy(vector_math_64.Vector4),
    tqpp: dart.legacy(vector_math_64.Vector4),
    tqpq: dart.legacy(vector_math_64.Vector4),
    tqqs: dart.legacy(vector_math_64.Vector4),
    tqqt: dart.legacy(vector_math_64.Vector4),
    tqqp: dart.legacy(vector_math_64.Vector4),
    tqqq: dart.legacy(vector_math_64.Vector4),
    psss: dart.legacy(vector_math_64.Vector4),
    psst: dart.legacy(vector_math_64.Vector4),
    pssp: dart.legacy(vector_math_64.Vector4),
    pssq: dart.legacy(vector_math_64.Vector4),
    psts: dart.legacy(vector_math_64.Vector4),
    pstt: dart.legacy(vector_math_64.Vector4),
    pstp: dart.legacy(vector_math_64.Vector4),
    pstq: dart.legacy(vector_math_64.Vector4),
    psps: dart.legacy(vector_math_64.Vector4),
    pspt: dart.legacy(vector_math_64.Vector4),
    pspp: dart.legacy(vector_math_64.Vector4),
    pspq: dart.legacy(vector_math_64.Vector4),
    psqs: dart.legacy(vector_math_64.Vector4),
    psqt: dart.legacy(vector_math_64.Vector4),
    psqp: dart.legacy(vector_math_64.Vector4),
    psqq: dart.legacy(vector_math_64.Vector4),
    ptss: dart.legacy(vector_math_64.Vector4),
    ptst: dart.legacy(vector_math_64.Vector4),
    ptsp: dart.legacy(vector_math_64.Vector4),
    ptsq: dart.legacy(vector_math_64.Vector4),
    ptts: dart.legacy(vector_math_64.Vector4),
    pttt: dart.legacy(vector_math_64.Vector4),
    pttp: dart.legacy(vector_math_64.Vector4),
    pttq: dart.legacy(vector_math_64.Vector4),
    ptps: dart.legacy(vector_math_64.Vector4),
    ptpt: dart.legacy(vector_math_64.Vector4),
    ptpp: dart.legacy(vector_math_64.Vector4),
    ptpq: dart.legacy(vector_math_64.Vector4),
    ptqs: dart.legacy(vector_math_64.Vector4),
    ptqt: dart.legacy(vector_math_64.Vector4),
    ptqp: dart.legacy(vector_math_64.Vector4),
    ptqq: dart.legacy(vector_math_64.Vector4),
    ppss: dart.legacy(vector_math_64.Vector4),
    ppst: dart.legacy(vector_math_64.Vector4),
    ppsp: dart.legacy(vector_math_64.Vector4),
    ppsq: dart.legacy(vector_math_64.Vector4),
    ppts: dart.legacy(vector_math_64.Vector4),
    pptt: dart.legacy(vector_math_64.Vector4),
    pptp: dart.legacy(vector_math_64.Vector4),
    pptq: dart.legacy(vector_math_64.Vector4),
    ppps: dart.legacy(vector_math_64.Vector4),
    pppt: dart.legacy(vector_math_64.Vector4),
    pppp: dart.legacy(vector_math_64.Vector4),
    pppq: dart.legacy(vector_math_64.Vector4),
    ppqs: dart.legacy(vector_math_64.Vector4),
    ppqt: dart.legacy(vector_math_64.Vector4),
    ppqp: dart.legacy(vector_math_64.Vector4),
    ppqq: dart.legacy(vector_math_64.Vector4),
    pqss: dart.legacy(vector_math_64.Vector4),
    pqst: dart.legacy(vector_math_64.Vector4),
    pqsp: dart.legacy(vector_math_64.Vector4),
    pqsq: dart.legacy(vector_math_64.Vector4),
    pqts: dart.legacy(vector_math_64.Vector4),
    pqtt: dart.legacy(vector_math_64.Vector4),
    pqtp: dart.legacy(vector_math_64.Vector4),
    pqtq: dart.legacy(vector_math_64.Vector4),
    pqps: dart.legacy(vector_math_64.Vector4),
    pqpt: dart.legacy(vector_math_64.Vector4),
    pqpp: dart.legacy(vector_math_64.Vector4),
    pqpq: dart.legacy(vector_math_64.Vector4),
    pqqs: dart.legacy(vector_math_64.Vector4),
    pqqt: dart.legacy(vector_math_64.Vector4),
    pqqp: dart.legacy(vector_math_64.Vector4),
    pqqq: dart.legacy(vector_math_64.Vector4),
    qsss: dart.legacy(vector_math_64.Vector4),
    qsst: dart.legacy(vector_math_64.Vector4),
    qssp: dart.legacy(vector_math_64.Vector4),
    qssq: dart.legacy(vector_math_64.Vector4),
    qsts: dart.legacy(vector_math_64.Vector4),
    qstt: dart.legacy(vector_math_64.Vector4),
    qstp: dart.legacy(vector_math_64.Vector4),
    qstq: dart.legacy(vector_math_64.Vector4),
    qsps: dart.legacy(vector_math_64.Vector4),
    qspt: dart.legacy(vector_math_64.Vector4),
    qspp: dart.legacy(vector_math_64.Vector4),
    qspq: dart.legacy(vector_math_64.Vector4),
    qsqs: dart.legacy(vector_math_64.Vector4),
    qsqt: dart.legacy(vector_math_64.Vector4),
    qsqp: dart.legacy(vector_math_64.Vector4),
    qsqq: dart.legacy(vector_math_64.Vector4),
    qtss: dart.legacy(vector_math_64.Vector4),
    qtst: dart.legacy(vector_math_64.Vector4),
    qtsp: dart.legacy(vector_math_64.Vector4),
    qtsq: dart.legacy(vector_math_64.Vector4),
    qtts: dart.legacy(vector_math_64.Vector4),
    qttt: dart.legacy(vector_math_64.Vector4),
    qttp: dart.legacy(vector_math_64.Vector4),
    qttq: dart.legacy(vector_math_64.Vector4),
    qtps: dart.legacy(vector_math_64.Vector4),
    qtpt: dart.legacy(vector_math_64.Vector4),
    qtpp: dart.legacy(vector_math_64.Vector4),
    qtpq: dart.legacy(vector_math_64.Vector4),
    qtqs: dart.legacy(vector_math_64.Vector4),
    qtqt: dart.legacy(vector_math_64.Vector4),
    qtqp: dart.legacy(vector_math_64.Vector4),
    qtqq: dart.legacy(vector_math_64.Vector4),
    qpss: dart.legacy(vector_math_64.Vector4),
    qpst: dart.legacy(vector_math_64.Vector4),
    qpsp: dart.legacy(vector_math_64.Vector4),
    qpsq: dart.legacy(vector_math_64.Vector4),
    qpts: dart.legacy(vector_math_64.Vector4),
    qptt: dart.legacy(vector_math_64.Vector4),
    qptp: dart.legacy(vector_math_64.Vector4),
    qptq: dart.legacy(vector_math_64.Vector4),
    qpps: dart.legacy(vector_math_64.Vector4),
    qppt: dart.legacy(vector_math_64.Vector4),
    qppp: dart.legacy(vector_math_64.Vector4),
    qppq: dart.legacy(vector_math_64.Vector4),
    qpqs: dart.legacy(vector_math_64.Vector4),
    qpqt: dart.legacy(vector_math_64.Vector4),
    qpqp: dart.legacy(vector_math_64.Vector4),
    qpqq: dart.legacy(vector_math_64.Vector4),
    qqss: dart.legacy(vector_math_64.Vector4),
    qqst: dart.legacy(vector_math_64.Vector4),
    qqsp: dart.legacy(vector_math_64.Vector4),
    qqsq: dart.legacy(vector_math_64.Vector4),
    qqts: dart.legacy(vector_math_64.Vector4),
    qqtt: dart.legacy(vector_math_64.Vector4),
    qqtp: dart.legacy(vector_math_64.Vector4),
    qqtq: dart.legacy(vector_math_64.Vector4),
    qqps: dart.legacy(vector_math_64.Vector4),
    qqpt: dart.legacy(vector_math_64.Vector4),
    qqpp: dart.legacy(vector_math_64.Vector4),
    qqpq: dart.legacy(vector_math_64.Vector4),
    qqqs: dart.legacy(vector_math_64.Vector4),
    qqqt: dart.legacy(vector_math_64.Vector4),
    qqqp: dart.legacy(vector_math_64.Vector4),
    qqqq: dart.legacy(vector_math_64.Vector4)
  }));
  ...
  dart.setLibraryUri(vector_math_64.Vector4, L0);
  dart.setFieldSignature(vector_math_64.Vector4, () => ({
    __proto__: dart.getFields(vector_math_64.Vector4.__proto__),
    [_v4storage$]: dart.finalFieldType(dart.legacy(typed_data.Float64List))
  }));
  ...
  vector_math_64.relativeError = function relativeError(calculated, correct) {
    if (numL().is(calculated) && numL().is(correct)) {
      let diff = (dart.notNull(calculated) - dart.notNull(correct))[$abs]()[$toDouble]();
      return diff / dart.notNull(correct);
    }
    return doubleL().as(dart.dsend(calculated, 'relativeError', [correct]));
  };
  vector_math_64.absoluteError = function absoluteError(calculated, correct) {
    ...
    return doubleL().as(dart.dsend(calculated, 'absoluteError', [correct]));
  };
...
//# sourceMappingURL=vector_math_64.unsound.ddc.js.map
