define(['dart_sdk'], (function load__packages__flutter_web__src__physics__clamped_simulation(dart_sdk) {
  'use strict';
  ...
  var L6 = "package:flutter_web/src/physics/clamped_simulation.dart";
  var L2 = "org-dartlang-app:///packages/flutter_web/src/physics/gravity_simulation.dart";
  var L1 = "org-dartlang-app:///packages/flutter_web/src/physics/utils.dart";
  var L0 = "package:flutter_web/src/physics/tolerance.dart";
  var L5 = "org-dartlang-app:///packages/flutter_web/src/physics/clamped_simulation.dart";
  var L3 = "package:flutter_web/src/physics/simulation.dart";
  var L9 = "org-dartlang-app:///packages/flutter_web/src/physics/friction_simulation.dart";
  var L4 = "package:flutter_web/src/physics/gravity_simulation.dart";
  var L7 = "package:flutter_web/src/physics/spring_simulation.dart";
  var L8 = "org-dartlang-app:///packages/flutter_web/src/physics/spring_simulation.dart";
  var L10 = "package:flutter_web/src/physics/friction_simulation.dart";
  dart.defineLazy(CT, {
    get C0() {
    ...
    get C4() {
      return C4 = dart.constList([C1 || CT.C1, C2 || CT.C2, C3 || CT.C3], SpringTypeL());
    }
  }, false);
  ...
  dart.setMethodSignature(tolerance.Tolerance, () => ({
    __proto__: dart.getMethods(tolerance.Tolerance.__proto__),
    toString: dart.fnType(dart.legacy(core.String), []),
    [$toString]: dart.fnType(dart.legacy(core.String), [])
  }));
  dart.setLibraryUri(tolerance.Tolerance, L0);
  ...
  utils.nearEqual = function nearEqual(a, b, epsilon) {
    if (!(epsilon != null)) dart.assertFailed(null, L1, 11, 10, "epsilon != null");
    if (!(dart.notNull(epsilon) >= 0.0)) dart.assertFailed(null, L1, 12, 10, "epsilon >= 0.0");
  ...
  dart.setMethodSignature(simulation.Simulation, () => ({
    __proto__: dart.getMethods(simulation.Simulation.__proto__),
    toString: dart.fnType(dart.legacy(core.String), []),
    [$toString]: dart.fnType(dart.legacy(core.String), [])
  }));
  dart.setLibraryUri(simulation.Simulation, L3);
  dart.setFieldSignature(simulation.Simulation, () => ({
    __proto__: dart.getFields(simulation.Simulation.__proto__),
    tolerance: dart.fieldType(dart.legacy(tolerance.Tolerance))
  }));
  ...
  (gravity_simulation.GravitySimulation.new = function(acceleration, distance, endDistance, velocity) {
    if (!(acceleration != null)) dart.assertFailed(null, L2, 52, 16, "acceleration != null");
    if (!(distance != null)) dart.assertFailed(null, L2, 53, 16, "distance != null");
    if (!(velocity != null)) dart.assertFailed(null, L2, 54, 16, "velocity != null");
    if (!(endDistance != null)) dart.assertFailed(null, L2, 55, 16, "endDistance != null");
    if (!(dart.notNull(endDistance) >= 0)) dart.assertFailed(null, L2, 56, 16, "endDistance >= 0");
  ...
  dart.addTypeCaches(gravity_simulation.GravitySimulation);
  ...
  dart.setLibraryUri(gravity_simulation.GravitySimulation, L4);
  dart.setFieldSignature(gravity_simulation.GravitySimulation, () => ({
    ...
    [_v]: dart.finalFieldType(dart.legacy(core.double)),
    [_a]: dart.finalFieldType(dart.legacy(core.double)),
  ...
  (clamped_simulation.ClampedSimulation.new = function(simulation, opts) {
    ...
    this[dxMin$] = dxMin;
    this[dxMax$] = dxMax;
    if (!(simulation != null)) dart.assertFailed(null, L5, 31, 15, "simulation != null");
    if (!(dart.notNull(xMax) >= dart.notNull(xMin))) dart.assertFailed(null, L5, 32, 15, "xMax >= xMin");
    if (!(dart.notNull(dxMax) >= dart.notNull(dxMin))) dart.assertFailed(null, L5, 33, 15, "dxMax >= dxMin");
  ...
  dart.addTypeCaches(clamped_simulation.ClampedSimulation);
  ...
  dart.setLibraryUri(clamped_simulation.ClampedSimulation, L6);
  dart.setFieldSignature(clamped_simulation.ClampedSimulation, () => ({
    ...
    simulation: dart.finalFieldType(dart.legacy(simulation.Simulation)),
    xMin: dart.finalFieldType(dart.legacy(core.double)),
    xMax: dart.finalFieldType(dart.legacy(core.double)),
    dxMin: dart.finalFieldType(dart.legacy(core.double)),
    dxMax: dart.finalFieldType(dart.legacy(core.double))
  }));
  ...
  spring_simulation.SpringDescription = class SpringDescription extends core.Object {
    ...
    toString() {
      return dart.str(this.runtimeType) + "(mass: " + dart.str(this.mass[$toStringAsFixed](1)) + ", stiffness: " + dart.str(this.stiffness[$toStringAsFixed](1)) + ", damping: " + dart.str(this.damping[$toStringAsFixed](1)) + ")";
    }
  };
  ...
  dart.setLibraryUri(spring_simulation.SpringDescription, L7);
  ...
  dart.setLibraryUri(spring_simulation.SpringType, L7);
  ...
  dart.setLibraryUri(spring_simulation.SpringSimulation, L7);
  ...
  dart.setLibraryUri(spring_simulation.ScrollSpringSimulation, L7);
  spring_simulation._SpringSolution = class _SpringSolution extends core.Object {
    static new(spring, initialPosition, initialVelocity) {
      if (!(spring != null)) dart.assertFailed(null, L8, 148, 12, "spring != null");
      if (!(spring.mass != null)) dart.assertFailed(null, L8, 149, 12, "spring.mass != null");
      if (!(spring.stiffness != null)) dart.assertFailed(null, L8, 150, 12, "spring.stiffness != null");
      if (!(spring.damping != null)) dart.assertFailed(null, L8, 151, 12, "spring.damping != null");
      if (!(initialPosition != null)) dart.assertFailed(null, L8, 152, 12, "initialPosition != null");
      if (!(initialVelocity != null)) dart.assertFailed(null, L8, 153, 12, "initialVelocity != null");
  ...
  dart.setLibraryUri(spring_simulation._SpringSolution, L7);
  ...
  dart.setLibraryUri(spring_simulation._CriticalSolution, L7);
  ...
  dart.setLibraryUri(spring_simulation._OverdampedSolution, L7);
  ...
  dart.setLibraryUri(spring_simulation._UnderdampedSolution, L7);
  ...
  friction_simulation.FrictionSimulation = class FrictionSimulation extends simulation.Simulation {
    static through(startPosition, endPosition, startVelocity, endVelocity) {
      if (!(startVelocity === 0.0 || endVelocity === 0.0 || startVelocity[$sign] === endVelocity[$sign])) dart.assertFailed(null, L9, 45, 12, "startVelocity == 0.0 || endVelocity == 0.0 || startVelocity.sign == endVelocity.sign");
      if (!(startVelocity[$abs]() >= endVelocity[$abs]())) dart.assertFailed(null, L9, 46, 12, "startVelocity.abs() >= endVelocity.abs()");
      if (!((dart.notNull(endPosition) - dart.notNull(startPosition))[$sign] === startVelocity[$sign])) dart.assertFailed(null, L9, 47, 12, "(endPosition - startPosition).sign == startVelocity.sign");
  ...
  dart.setMethodSignature(friction_simulation.FrictionSimulation, () => ({
    ...
    x: dart.fnType(dart.legacy(core.double), [dart.legacy(core.double)]),
    dx: dart.fnType(dart.legacy(core.double), [dart.legacy(core.double)]),
    timeAtX: dart.fnType(dart.legacy(core.double), [dart.legacy(core.double)]),
    isDone: dart.fnType(dart.legacy(core.bool), [dart.legacy(core.double)])
  }));
  dart.setGetterSignature(friction_simulation.FrictionSimulation, () => ({
    ...
    finalX: dart.legacy(core.double)
  }));
  dart.setLibraryUri(friction_simulation.FrictionSimulation, L10);
  dart.setFieldSignature(friction_simulation.FrictionSimulation, () => ({
    ...
    [_drag]: dart.finalFieldType(dart.legacy(core.double)),
    [_dragLog]: dart.finalFieldType(dart.legacy(core.double)),
    [_x$]: dart.finalFieldType(dart.legacy(core.double)),
    [_v$]: dart.finalFieldType(dart.legacy(core.double))
  }));
  ...
  (friction_simulation.BoundedFrictionSimulation.new = function(drag, position, velocity, _minX, _maxX) {
    this[_minX$] = _minX;
    this[_maxX$] = _maxX;
    if (!(position[$clamp](_minX, _maxX) === position)) dart.assertFailed(null, L9, 112, 14, "position.clamp(_minX, _maxX) == position");
  ...
  dart.setLibraryUri(friction_simulation.BoundedFrictionSimulation, L10);
  dart.setFieldSignature(friction_simulation.BoundedFrictionSimulation, () => ({
    ...
    [_minX$]: dart.finalFieldType(dart.legacy(core.double)),
    [_maxX$]: dart.finalFieldType(dart.legacy(core.double))
  }));
...
//# sourceMappingURL=clamped_simulation.unsound.ddc.js.map
